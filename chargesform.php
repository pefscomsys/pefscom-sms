...
<blockquote style='float:left; margin-left:10px;width:55%;height:100px;'>
  <h2>Print Hard Copy Result (Archieves)</h2>
...
<div class="panel panel-default"  style='float:left; width:1000px;margin-left:10px; height:300px;'>
  <div class="panel-body">
 <div class="embed-responsive embed-responsive-16by9" style=''>
    <iframe class="embed-responsive-item" src="tablesds4e.php" style='float:left; height:280px; '></iframe>
  </div>
  </div>
</div>
