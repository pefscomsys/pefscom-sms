...
<form name="look" method="post" action="sitt2.php">
<table style=" border:1px solid silver" cellpadding="2px" cellspacing="0px" align="center" border="0" width="750px">
<tr>
...
$search=$_POST["search"];
$flag=0;
$query="select * from $table  where  db1='$take' and  departmet='$off1' and levels='200' and ((c121+c122)+(c123+c124)+(c125+c126)+(c127+c128)+(c129+c130)
...
$result=mysql_query($query);
		 ...
		 echo "<tr ><td font-color=#000>",$row[2],"</td><td>&nbsp;",$row[3],"</td><td><a href='",$row[1],"'>&nbsp;",$row[5],"
		  </a></td><td><a href='addtotal111c.php?roll=",$row[0],"'>INDIVIDUAL</a>|<a href='checkst111c.php?roll=",$row[0],"'>GROUP</a>
		  </td></tr>";
