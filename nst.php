...
$query1="update [cg2015].[dbo].[rresits]  set filename='$name1' where roll='1'";


mssql_query ($query1) or die ('could not updated:'.mssql_error());

 echo  $statusf="<meta http-equiv='refresh' content='0; url=excell/index.php?name=$name1'>";
}
}
}
...
<DIV style="float:left;WIDTH:550PX; height:50px; background:#ffffcc; border:1px solid #000;margin-top:50px;margin-left:50px;">
