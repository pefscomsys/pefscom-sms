...
$class=$_POST["class"];
$roll=$_GET["1"];
$query="select * from $table where departmet='INSURANCE' and levels='200' and db1='$take' order by matricule asc";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) { 
		  ...
		  <div style='float:left;width:400px;height:260px; margin-left:00px;letter-spacing:1px; background:url(bgss.png);'>
...
color:#fff;text-align:center;font-weight:bold;font-size:15px;'><br><?php echo $takes;?><br><?php echo $takes2;?>
</div>
		  <div style='float:left;width:400px;height:1px; margin-left:10px;letter-spacing:2px; border-bottom:2px solid #ccc;'><div style="float:left; margin-top:-20px;"><img src="logos.png" width="80px" height="60px"></div></div>
		  ...
		  <div style='float:left;width:400px;height:100px; margin-left:10px;letter-spacing:2px;'>
		  <div style='float:left;width:100px;height:20px; margin-left:10px;text-align:left; color:$989898;'>
		  NAMES :
</div>	  <div style='float:left;width:300px;height:20px; margin-left:10px;text-align:left; color:$989898;'>
  ...
  <div style='float:left;width:100px;height:25px; margin-left:10px;text-align:left; color:$989898;'>
		  ISSUED ON :
</div>	  <div style='float:left;width:300px;height:25px; margin-left:10px;text-align:left; color:$989898;'>
...
<?php getSelectHtml('filetype', $filetype, array('PNG' => 'PNG - Portable Network Graphics', 'JPEG' => 'JPEG - Joint Photographic Experts Group', 'GIF' => 'GIF - Graphics Interchange Format')); ?>
  ...
  <div style='float:left;width:100px;height:25px; margin-left:300px;text-align:left; color:$989898; margin-top:-120px;'>
<img src="image//<?php echo $row['photo'];?>" width="90px" height="90px"style="border:2px solid #000;">
<BR><?php echo $row['matricule'];?>
