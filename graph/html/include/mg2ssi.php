...
define ("DB_NAME","himsbueas"); // set database name
...
$class=$_POST["class"];
$roll=$_GET["1"];
$query="select * from $table where departmet='MARKETING' and levels='400' and db1='$take' and cxx4='' order by matricule asc";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) { 
...
<title>STUDENT ID CARD</title>
<style>
#pretcon{float:left;margin-left:50px;height:370px;width:433px;}
...
<div style="float:left;margin-top:38px;margin-left:25px;">
...
<div id="coh1"style="margin-top:36px;">MINISTRY OF HIGHER EDUCATION</div>
...
<div style="float:left;margin-left:7px; width:100px; height:100px;margin-top:15px;">
<img src="image/<?php echo $row['photo'];?>" width="100px" height="85px" style="border:3px solid #efefef;">
...
<img src="image/<?php echo $row['photo'];?>" width="40px" height="35px" style="border:1px solid #efefef;">
</div>
</div>
<?php 
...
<div style="float:left;
width:150px;;height:15px;text-align:left;font-size:13px;font-weight:normal;font-weight:bold;">BTECH</div>
...
<div style="float:left;
width:150px;;height:15px;text-align:left;font-size:13px;font-weight:normal;color:#ff6666;"><?php $month=date('m');$day=date('j');$y=date('Y'); ?><?php echo $day;?>/<?php echo $month+5;?>
/<?php echo $y+1;?></div>
...
width:300px;;height:15px;text-align:left;font-size:12px;font-weight:normal;color:#989898;">
		 ...
		 <div style='float:left;width:250px;height:25px;  margin-top:-15px;color:$989898;margin-left:194px;'>
<?php
$matricule="";
$default_value = array();
...
<div  style="float:left;width:460px;background:#75d5fa; height:40px;margin-left:-123px; margin-top:10px;">
