...
$result=mysql_query($query);
	...
	<b>HIGHER INSTITUTE OF MANAGEMENT STUDIES (HIMS BUEA) </b><?php echo $school6b;?> <BR><?php echo $school7;?> <?php echo $school7b;?> <br>
...
STUDENT ACADEMIC RECORD
		...
		This transcript is not valid without the Seal, the signature of the Rector and that of the Dean of studies
		    </div>
		    </div>
			</div>
...
$row = mysql_fetch_assoc($qry); 
 $credit1s2t2=$row['total']; 
  ?>
		...
		<b> CUMMULATIVE TOTAL GPA CREDIT EARNED :</b> <?php echo $x=($savept19+$savept20);?>
