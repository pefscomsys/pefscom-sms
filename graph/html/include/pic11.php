...
$class=$_POST["class"];
$roll=$_GET["1"];
$query="select * from $table where  db1='$take'  and levels>=300 && levels<=300 order by matricule asc";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) { 
...
<div style="float:left;margin-left:0px; width:100px; height:100px;margin-top:15px;">
			...
			<?php  $roll=$row['roll'];?>	
<img src="load_image.php?pic_id=<?php echo $roll;?>" width="103px" height="90px"style="border:1px solid #efefef;">
