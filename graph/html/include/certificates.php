...
$query = mysql_query("select  * from subject where  year1='$level' and department='$deptt' and year2='1' and  db1>''  order by db1 ASC"); 
...
from subject where  year1='$level' and department='$deptt' and year2='1' and  db1>'' "); 
$row = mysql_fetch_assoc($qry); 
...
$take=$pt;
echo $levels;
$query = mysql_query("select  * from subject where  year1='$level' and department='$deptt' and year2='2' and  db1>''  order by db1 ASC"); 
...
$qry = mysql_query("select (c101+c102) as total
from resit where db1='$take' and fname='$courseps' and matricule='$mats' and departmet='$deptt' and sex='2' and levels='$level'  and fname>'' "); 
$row = mysql_fetch_assoc($qry); 
$ns=$row['total']; 
...
$qry = mysql_query("select  SUM(credit) as total
from subject where  year1='$level' and department='$deptt' and year2='2' and  db1>'' "); 
$row = mysql_fetch_assoc($qry); 
...
$statusfbiog=printf("%01.2f",($nalls/$marks11));
}
...
if(empty($fggs)){
 ...
 $marks11; 
		...
		<b> CUMMULATIVE AVERAGE: $statusfbiog;  </B>
