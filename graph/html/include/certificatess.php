...
<?php
$query="select * from courses where departmet='$deptt' and levels='200'  and db1='$db1'
";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
		...
		<div style="float:left; width:1408px; margin-left:-60px;height:965px; MARGIN-TOP:-80PX;  BACKGROUND:URL(report.png); font-family:times;">
		 ...
		 <div style="float:left; width:1400px;font-size:18px; height:140px; color:#000; border:1px solid #000;">
...
?></B>
		 ...
		 <div style="float:left; width:1400px; font-size:18px;height:100px;margin-top:4px; color:#000; border:1px solid #000;">
...
<?php echo $deptt=$row["departmet"]; $level=$row["levels"];?>
 ...
 <div style="float:left; width:319px; height:70px;MARGIN-TOP:10PX; color:#000; text-align:center;font-weight:bold;line-height:23px; ">
		 ...
		 <div style="float:left; width:1400px;font-size:18px; height:100px;margin-top:4px; color:#000; ">
		...
		<B>REGISTRAR</B>
		 ...
		 <div style="float:left; width:70px; height:25px;color:#000; ">
		  ...
		  <div style="float:left; width:450px;TEXT-ALIGN:CENTER; height:65px;color:#000;MARGIN-TOP:5PX; ">
