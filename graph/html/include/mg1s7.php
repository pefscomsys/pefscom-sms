...
<?php
$roll=$_GET["1"];
$query="select * from classes where  roll='7'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
...
$class=$_POST["class"];
$roll=$_GET["1"];
$query="select * from $table where  db1='$take'  and levels>=200 && levels<=200 and  departmet='$off1in7' order by departmet asc";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) { 
...
<div style="float:left;margin-left:0px; width:100px; height:100px;margin-top:15px;">
...
<div style="float:left;
width:150px;;height:15px;text-align:left;font-size:13px;"><?php echo $date;?></div>
...
<div style="float:left;font-size:18px;font-family:Century Gothic;color:#000;margin-left:40px; "><b><?php echo $fname;?></b></div> &nbsp;&nbsp;&nbsp; 
