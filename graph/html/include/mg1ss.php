...
$class=$_POST["class"];
$roll=$_GET["1"];
$query="select * from $table where  db1='$take'  and levels>=300 && levels<=300 and departmet='ACCOUNTANCY' order by departmet asc";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) { 
...
from employees where empname='$mxx' and ext='$take'"); 
