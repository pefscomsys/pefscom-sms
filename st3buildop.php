...
<div style="float:left;margin-top:5px;margin-left:5px;">&#9658;</div>
 ...
 <div style="float:left; width:620px;color:#1188aa; height:30px;font-size:28px;color:#fff;text-transform:uppercase;">Type a name and search</div>
...
<div style="float:left; width:850px; height:360px;margin-left:-100px; ">	

<iframe title="" class="youtube-player" type="text/html" 
width="1050px" height="360px" src="st3bm.php"
frameborder="2" allowFullScreen style="
 border: 0px solid #ffffff;margin-top:10px;margin-left:-50px;"></iframe>
