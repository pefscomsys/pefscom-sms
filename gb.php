...
<form method="post" action="bbbb.php">
...
<select name="subject">
<?php
$rs=mysql_query("Select * from subject  order by  roll ASC",$link);
	  while($row=mysql_fetch_array($rs))
{
if($row[1]==$fees)
{
...
?></select>
        ...
        <button class="w2ui-btn" name="save" size="250px">Process Album</button>
    </div>
</div>
