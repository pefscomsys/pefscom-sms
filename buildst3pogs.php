...
echo "<script>alert('Data Base Updated Successful!'); window.location.href('marks.php');</script>";
 ...
 echo $statusftydate="<meta http-equiv='refresh' content='0; url=st3bms.php'>";
 }
?>		
<?php
...
while($row = mysql_fetch_assoc($results))
{
 ...
 $sex_array[] = $row["sex"]; $c109_array[] = $row["c109"];
...
for($i=0;$i<count($id_array);$i++)
{
 ...
 $fname = $fname_array[$i];
  ...
  $sex = $sex_array[$i]; $c109 = $c109_array[$i];
...
">
<input type="text" name="fname[]" value="<?php echo $courseps=$fname;?>" size="8">
</td><td style="float:left; width:200px; height:25px;
">
...
<td style="float:left; width:70px; height:25px;
">
<input type="text" name="c109[]" value="<?php echo $c109;?>" size="4">
...
<td style="float:left; width:70px; height:25px;
">
<input type="text" name="c101[]" readonly='readonly'value="<?php echo $c101;?>" size="4">

</td>
<td style="float:left; width:70px; height:25px;
">
<input type="text" name="c102[]"readonly='readonly' value="<?php echo $c102;?>" size="4">

</td>
<td style="float:left; width:70px; height:25px;
">
<input type="text" name="c102g[]" readonly='readonly'value="<?php echo $c102+$c101;?>" size="4">

</td>

<td style="float:left; width:100px; height:25px;
">
<input type="text" name="sex[]" readonly='readonly'value="<?php echo $sex;?>" placeholder='' size="4">

</td>

<td style="float:left; width:100px; height:25px;
">
<input type="text" name="levels[]" readonly='readonly'value="<?php echo $levels;?>" size="4"></td>
