...
$query="select * from subject where year1>='$ms' &&  year1<='$ms' and department>='$dept' and department<='$dept' order by year2 ASC";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
?>
...
<td style="float:left;text-align:left;"><?php echo $row["db1"];?></td>
<td style="float:left;text-align:left;"><a href="sync-mysql3.php?levels=<?php echo $ms;?>&db1=<?php echo $db1;?>&dept=<?php echo $dept;?>&pic=<?php echo $row["subject"];?>">
