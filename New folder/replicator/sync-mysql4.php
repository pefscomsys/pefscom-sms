...
mysql_select_db($db[1], $mr1);
  ...
  for ($i=0; $i<$n; $i++) {
    ...
    $q2 = "DELETE  FROM resit where db1='$db1'  and levels='$levels' and departmet='$dept'and sex='$sex'	";
    ...
    $q2 = "SELECT * FROM resit where db1='$db1' and levels='$levels' and departmet='$dept' and sex='$sex'";
