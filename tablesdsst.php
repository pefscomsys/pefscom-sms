...
if(searchid!='')
{
	$.ajax({
	type: "POST",
	url: "searchst.php?x=<?php echo $id;?>",
	data: dataString,
	cache: false,
...
<body>  
  ...
  <li class="active"><a href="#home" data-toggle="tab">Print Single Slip</a></li>
  <li><a href="tablesdssti.php?roll=<?php echo $id;?>" data-toggle="tab">Group/Department Slip</a></li>
