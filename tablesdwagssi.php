...
echo "<script>alert('Data Base Updated Successful!');</script>";
 ...
 echo  $statusf="<meta http-equiv='refresh' content='0; url=tablesdwagssi.php?usr_name=$user_name'>";
 exit;
...
$row = mssql_fetch_assoc($qry); 
 ...
 ?>' placeholder="Irshad"></td>
    <td><input class="form-control" name='classs[]' type="text"value='<?php echo $classs;?>' placeholder="Irshad" >
	
	<input class="form-control" name='deptf[]' type="hidden"value='<?php echo $deptf;?>' placeholder="Irshad" >
	
	
	
	<input class="form-control" name='code[]' type="hidden"value='<?php echo $code;?>' placeholder="Irshad" >
	
	
	
	</td>
	  <td><input class="form-control" name='fees[]' type="text"value='<?php echo $fees;?>' placeholder="Irshad" >
	 ...
	 <td><input class="form-control" name='dep[]' type="text"value='<?php echo $dep;?>' placeholder="Application Form"  >
	...
	<td><input class="form-control" name='form[]' type="text"value='<?php echo $form;?>' placeholder="Form"  >
		...
		<td><input class="form-control" name='sunion[]' type="text"value='<?php echo $sunion;?>' placeholder="Student Union"  >
