...
<div style="float:left; width:100px; height:80px;color:#fff;font-size:22px;"><div style="float:left;margin-top:5px;margin-left:5px;">&#9658;</div></div>
 <div style="float:left; width:400px;color:#1188aa; height:30px;font-size:20px;color:#fff;">HOME PAGE (Update Section)</div></div>
...
width="950px" height="470" src="changedepttp.php?roll=<?php echo $ids;?>"
frameborder="0" allowFullScreen style="
 border: 0px solid #ffffff;background:#efefef;margin-left:-150px;"></iframe><script type="text/javascript">
$(function () {
    $('#form').w2form({ 
        name   : 'form',
