...
?>
  ...
  <a href="transfersgks.php?dept=<?php echo $subs=$row['levels'];  $subss=$row['code'];?>&levels=<?php echo $leve;?>&db1=<?php echo $db1;?>&dept=<?php echo $dept;?>&sub=<?php echo $subss;?>" class="list-group-item">
