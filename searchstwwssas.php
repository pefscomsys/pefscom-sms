...
?>
 <tr>
	...
	<td><?php echo $db1;?></td>
    <td><a 
style='text-decoration:none;'  onclick="window.open('page/formbs.php?mats=<?php echo $matricule;?>&levels=<?php echo $year1;?>&rx=<?php echo $year1;?>&db1=<?php echo $db1;?>&ui=<?php echo $row["year1"];?>&dept=<?php echo $department;?>', '_blank', 'location=yes,height=570,width=520,scrollbars=yes,status=yes');">
