...
<div style="float:left; width:100px; height:80px;color:#fff;font-size:22px;"><div style="float:left;margin-top:5px;margin-left:5px;">&#9658;</div></div>
 <div style="float:left; width:400px;color:#1188aa; height:30px;font-size:20px;color:#fff;">HOME PAGE (Selection of Student Candidate)</div></div>
...
width="1000px" height="470" src="elecc.php"
