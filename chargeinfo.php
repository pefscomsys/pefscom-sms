...
$sex = $_POST ['sex'];$db1 = $_POST ['db1'];
$rolluuu = $_POST ['rolluuu'];
$cxx1 = $_POST ['cxx1'];$c112 = $_POST ['c112'];
$cxx2 = $_POST ['cxx2'];
$fname = $_POST ['fname'];$c101 = $_POST ['c101'];$c102 = $_POST ['c102'];$c110 = $_POST ['c110'];
$db1= $_POST ['db1'];
$cxx6 = $_POST ['cxx6'];
$sex = $_POST ['sex'];
$class = $_POST ['class'];
$query3="update  courses set fname='$fname',matricule='$matricule' ,departmet='$department',
levels='$class',c112='$c112',cxx1='$cxx1'

,c101='$c101',c102='$c102',c110='$c110'
...
,sex='$sex',cxx2='$cxx2',cxx6='$cxx6',db1='$db1'
 where roll='$rolluuu'
...
?>" style="background:#ccc;"/>
      ...
      <td style="text-transform:uppercase;"><input type="text" name="db1" size="19" value="<?php echo $row['db1'];?>"style="background:#ccc;" ></td>
 ...
 <tr>
	...
	<tr>
      <td style="text-transform:uppercase;">Start From</td>
      <td style="text-transform:uppercase;"><input type="text" name="c101" size="19" value="<?php echo $row['c101'];?>"style="background:#ccc;" ></td>
	...
	<tr>
      <td style="text-transform:uppercase;">End  On</td>
      <td style="text-transform:uppercase;"><input type="text" name="c102" size="19" value="<?php echo $row['c102'];?>"style="background:#ccc;" ></td>
...
<tr>  
    ...
    <tr><td >Add GPA</td>
      <td bgcolor=""><input type="text" name="c112" size="10" value="<?php echo $row['c112'];?>"  style="background:red;color:#fff;font-weight:bold;"></td>
<tr>  



    <tr><td >Special id</td>
      <td bgcolor=""><input type="text" name="c110" size="10" value="<?php echo $row['c110'];?>"  style="background:#ccc;color:#fff;font-weight:bold;"></td>
<tr>  
