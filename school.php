...
<blockquote style='float:left; margin-left:10px;width:65%;height:100px;'>
  ...
  <small>Create New School<cite title="Source Title"></cite></small>
</blockquote>

<div style='width:105%;height:300px;'>

<div class="panel panel-default"  style='float:left; width:55%;margin-left:10px; height:300px;'>
  <div class="panel-body">
 <div class="embed-responsive embed-responsive-16by9">
    <iframe class="embed-responsive-item" src="tablesdgs.php"></iframe>
  </div>
  </div>
</div>
...
<div   style='float:left; width:400px;margin-left:10px; height:300px;MARGIN-TOP:-40PX;'>
...
<ul class="nav nav-pills" style='margin-top:-25px;margin-left:25px;'>
 ...
 $faculty=$_POST["faculty"];
  $facc=$_POST["facc"]; $web=$_POST["web"]; $contact=$_POST["contact"];$email=$_POST["email"];
   $facid=$_POST["facid"]; $town=$_POST["town"];
  if(empty($faculty)){
...
$query="insert into [cg2015].[dbo].[school] 
(school,ids,code,town,website,email,contact)
values('$faculty','$facid','$facc',' $town',' $web',' $email',' $contact')
...
echo "<script>alert('New School Created!'); </script>";
 ...
 echo "<meta http-equiv='refresh' content='0; url=school.php'>";
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name='faculty' id="exampleInputEmail1" placeholder="New Institution" required='required'>
    <label for="exampleInputEmail1">Institution Constant</label>
    <input type="text" class="form-control" name='facc' id="exampleInputEmail1" placeholder="Institution Constant" required='required'>
	   <label for="exampleInputEmail1">Institution Address</label>
    <input type="text" class="form-control" name='town' id="exampleInputEmail1" placeholder="Institution Address" required='required'>
	   <label for="exampleInputEmail1">Institution Website</label>
    <input type="text" class="form-control" name='web' id="exampleInputEmail1" placeholder="Institution Website" required='required'>
	
		   <label for="exampleInputEmail1">Institution Contact</label>
    <input type="text" class="form-control" name='contact' id="exampleInputEmail1" placeholder="Institution contact" required='required'>
	
	
		   <label for="exampleInputEmail1">Institution Email</label>
    <input type="text" class="form-control" name='email' id="exampleInputEmail1" placeholder="Institution contact" required='required'>
  ...
  <div class="form-group">
    <label for="exampleInputPassword1">School  ID</label>
      <div >
