...
<blockquote style='float:left; margin-left:10px;width:65%;height:100px;'>
  <h2>Set Admission Fee for different specialty <h2>
  <small>Please set the expected amount for the student <cite title="Source Title"></cite></small>
</blockquote>

<a href='bustme.php'><button type="button" class="close" aria-label="Close">
  <span aria-hidden="true">&times; close</span>
</button></a>
<div style='width:110%;height:300px;'>

<div class="panel panel-default"  style='float:left; width:90%;margin-left:10px; height:450px;'>
  <div class="panel-body">
 <div class="embed-responsive embed-responsive-16by9">
    <iframe class="embed-responsive-item" src="tablesdwagssi.php" style='float:left;width:100%; height:420px;'></iframe>
  </div>
  </div>
</div>
