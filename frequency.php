...
<body onload='windows.print()'>
		<a onclick="window.open('frequencys.php?levels=<?php echo $levels;?>&department=<?php echo $department;?>&semester=<?php echo $semester;?>&db1=<?php echo $take;?>&S=<?php echo $semesters;?>', '_blank', 'location=yes,height=570,width=520,scrollbars=yes,status=yes');">
		<div class="page" STYLE="MARGIN-TOP:-75PX;">
 <div  class="btn btn-success"  style="color:#FFFFFF;">
Print!
</div></a>
<?php
...
$query = mssql_query("select  CAST(subject as nvarchar(400)) as subject, CAST(db1 as text) as db1 , CAST(extra as text) as credit from subject where department='$department' and year1='$levels' and year2='$semester' and db1>'' and acc='$take' order by subject ASC"); 
