...
<body  style='font-family:calibri;'>
		 ...
		 $deptt=$_GET["deptt"];
		 $levels=$_GET["levels"]; $session=$_GET["session"];
	 $qryg= "select  count(*) as total
FROM courses  where levels='$levels' and departmet='$deptt' and db1='$session' "; 
...
$row = mysql_fetch_assoc($tyyi); 
 ...
 $is=$totalpages; $x=20;
		...
		$rso="page 1";
		  ...
		  ?>
			 ...
			 <div class="page"  >
		 	 ...
		 	 <div style="float:left; width:900px; height:200px;margin-top:-50px; margin-left:-50px;  color:#000; text-align:center;">
	...
	(ETUDIANTS)
		 	 ...
		 	 <div style="float:left; width:900px; height:35px; text-align:center; color:#000; text-align:center;font-size:17px;">
 ...
 <div style="float:left; width:100px; height:25px;">
			 ...
			 </div><div style="float:left; width:150px; height:25px;">
			 <b>NOM DE L'E.C :   </b>                                                    
...
Exam
		...
		$resulths="SELECT *  FROM courses  where levels='$levels' and departmet='$deptt' and db1='$session'  order by fname ASC    limit 0, 20";
...
<?php echo $row["c114"];;?>
			  ...
			  <td style="width:460px;height:35px; text-transform:uppercase;padding:2px;text-align:left;border-right:1px dashed #ccc;border-bottom:1px dashed #ccc;">
&nbsp;&nbsp;<?php echo $row["fname"];?>
			  
			  </td>
			  
			  	  <td style="width:170px;height:35px; padding:2px;text-align:center;border-right:1px dashed #ccc;border-bottom:1px dashed #ccc;">
<?php echo $row["matricule"];?>  
			  </td>
			  
			    	  <td style="width:100px;height:35px; padding:2px;text-align:center;border-right:1px dashed #ccc;border-bottom:1px dashed #ccc;">
<?php echo $row["sex"];?>    
			  </td>
			  
			  	  <td style="width:130px;height:35px; padding:2px;text-align:center;border-right:1px dashed #ccc;border-bottom:1px dashed #ccc;">

			  
			  </td>  
			  
			  			  	  <td style="width:100px;height:35px; padding:2px;text-align:center;border-bottom:1px dashed #ccc;">
		 ...
		 <?php } ?>
			 	 	 ...
			 	 	 <div style="float:left; width:750px; height:25px; text-align:center; color:#000; text-align:right;font-size:25px;">
	<i>Page 1/<?php echo $is;?>
...
$cell=( ($numberrec-($cellx1)));
							 ...
							 $cels=$cell;
		$resulths="SELECT *  FROM courses  where levels='$levels' and departmet='$deptt' and db1='$session'   order by fname ASC LIMIT $cels, $cellx1 ";
...
<?php echo $row["sex"];?>    
		 ...
		 <?php } ?>
			 	 	  ...
			 	 	  <div style="float:left; width:750px; height:25px; text-align:center; color:#000; text-align:right;font-size:25px;">
	<i>Page <?php echo $packs;;?>/<?php echo $is;?>
