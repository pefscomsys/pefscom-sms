...
<blockquote style='float:left; margin-left:10px;width:85%;height:100px;'>
  <h2>Building Courses from One Academic year to another</h2>
...
<div class="panel panel-default"  style='float:left; width:100%;margin-left:10px; height:410px;'>
  <div class="panel-body">
 <div class="embed-responsive embed-responsive-16by9" style=''>
    <iframe class="embed-responsive-item" src="nmsst1s.php" style='float:left; height:380px; '></iframe>
  </div>
  </div>
</div>
