...
<body>  
					...
					$leve=$_GET['levels'];
 $query="select CAST(classs as text) as levels,CAST(code as text) as code from [cg2015].[dbo].[classes] ";
$result=mssql_query($query);
		 while ($row = mssql_fetch_array($result)) {
?>

  <a href="replicator/transferssg.php?dept=<?php echo $levels=$row['levels'];  $levels=$row['code'];?>&levels=<?php echo $leve;?>" class="list-group-item">
