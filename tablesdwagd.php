...
?>
 ...
 <div class="panel panel-default"  style='float:left; width:500px;margin-left:-20px; height:380px;'>
 
  <div class="panel-body">
 <div class="embed-responsive embed-responsive-16by9">
    <iframe class="embed-responsive-item" src="tsd.php?x=<?php echo $statusfbio;?>&db1=<?php echo $year;?>" style='float:left;width:100%; height:380px;'></iframe>
  </div>
  </div>
				  </div>
