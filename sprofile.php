...
<link href="popupgs.css" rel="stylesheet" type="text/css" />
...
<div id="popup">
<div style="float:left; width:845px;border-bottom:1px solid #000;margin-top:3px; height:40px;background:rgb(120,80,100);">
...
<div style="float:left; width:100px; height:80px;color:#fff;font-size:22px;"><div style="float:left;margin-top:5px;margin-left:5px;">&#9658;</div></div>
 <div style="float:left; width:400px;color:#1188aa; height:30px;font-size:28px;color:#fff;text-transform:uppercase;"><?php echo $pic;?> & student info</div></div>
...
<div style="float:left; width:500px;border-bottom:1px solid #000;margin-top:15px; height:30px;margin-left:75px;background:rgb(120,80,100);">
			...
			Year
				...
				<div style="float:left; width:130px;text-align:left;margin-top:4px; height:25px;color:#fff;">
			Startdate
			</div>
...
$query="select * from $pic where db1>''";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
?>
<a href="poppp.php?roll=<?php echo $row["id"];?>&amp=<?php echo $row["comment"];?>&fac=<?php echo $row["facultyno"];?>&sec=<?php echo $row["section"];?>">
<div style="float:left; width:650px; height:25px;font-size:14px;margin-top:-4px;">
	...
	<?php echo $row["id"];?>
			...
			<div style="float:left;background:#ccc; width:150px;text-align:left;border-right:1px solid #fff;border-bottom:1px solid #fff; height:24px;text-transform:uppercase;">
				<div style="float:left; width:150px;margin-top:3px;margin-left:5px;">

<?php echo $row["db1"];?>
			</div>
			</div>
				<div style="float:left;background:#ccc; width:120px;text-align:left;border-right:1px solid #fff;border-bottom:1px solid #fff; height:24px;text-transform:uppercase;">
				<div style="float:left; width:120px;margin-top:3px;margin-left:5px;">

<?php echo $row["startdate"];?>
			</div>
			</div><div style="float:left;background:#ccc; width:110px;text-align:left;border-right:1px solid #fff;border-bottom:1px solid #fff; height:24px;text-transform:uppercase;">
				<div style="float:left; width:110px;margin-top:3px;margin-left:5px;">

<?php echo $row["enddate"];?>
			</div>
			</div>
					<div style="float:left;background:#ccc; width:80px;text-align:left;border-right:1px solid #fff;border-bottom:1px solid #fff; height:24px;text-transform:uppercase;">
				<div style="float:left; width:80px;margin-top:3px;margin-left:5px;">
...
<div style="float:left; width:50px;text-align:left; height:24px;">
	...
	<a href="news.php?roll=<?php echo $pic;?>">
&#9658; New <?php echo $pic;?></a>
			</div>
			</div>
