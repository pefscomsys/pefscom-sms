...
<div id="popup">
<div class="row" >
  <div class="col-md-3" style='width:110%;height:450px;margin-top:15px;'>
<blockquote style='float:left; margin-left:10px;width:55%;height:100px;'>
  <h2>Frequency Distrubution Table, Showing Grade,etc</h2>
  <small>Select Department, Academic Year, level <cite title="Source Title"></cite></small>
...
<div class="panel panel-default"  style='float:left; width:110%;margin-left:10px; height:300px;'>
  <div class="panel-body">
 <div class="embed-responsive embed-responsive-16by9" style=''>
    <iframe class="embed-responsive-item" src="tablesdsa.php" style='float:left; width:130%;height:280px; '></iframe>
  </div>
  </div>
</div>
