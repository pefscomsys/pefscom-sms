...
$user_name=$notes;
if(@$_SESSION['userlevel']!=10){header("location: login.php?error=Unauthorized access");}
...
<div style="float:left; width:100px; height:80px;color:#fff;font-size:22px;"><div style="float:left;margin-top:5px;margin-left:5px;">&#9658;</div></div>
 <div style="float:left; width:300px;color:#1188aa; height:30px;font-size:28px;color:#fff;">HOME PAGE</div></div>
...
<tr  style="border-bottom:1px solid #ccc;"><td style="float:left;text-align:left;">&#9658;</td><td style="float:left;text-align:left;"><a href="<?php echo $row["link"];?>?roll=<?php echo $row["code"];?>&amp=<?php echo $levels;?>&rx=<?php echo $db1;?>&pic=<?php echo $row["faculty"];?>"><?php echo $row["page"];?></a>	
					</td></tr>
