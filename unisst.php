...
?>	  
<body onload="window.print();" style='font-family:calibri;'> <?php 
	$session=$db1;
		 ...
		 ?>
			 <div class="page"  >
		 	 ...
		 	 <div style="float:left;width:750px;text-align:center; Height:35px;margin-left:-200px; font-size:25px;"> <b style="font-size:25px;"> <?php echo $schoolx;?></B>
			 </div>
...
GPA
			 ...
			 FROM courses  where levels='$levels' and departmet='$deptt' and db1='$session'  order by fname ASC";
		
$dssss=mssql_query($resulths);$iJ=1;
