...
<form name="look" method="post" action="sit.php?roll=<?php echo $roll;?>&term=<?php echo $term;?>">
...
$search=$_POST["search"];
$flag=0;
$query="select * from $table  where  db1='$take'  and  departmet='$rem' and levels='200'  and c139='1'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
		 $flag=1;
