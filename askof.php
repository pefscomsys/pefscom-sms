...
$ids=$_POST['ids'];
$roll=$_POST['roll'];$cash=$_POST['cashed'];
...
$expected_amounst=$_POST['expected_amounst'];
...
id='3',name='FEES',amount='0',amount2='0',folk='$paid',cash='$cash',
date='$dates',fname='$matricule',month='$month',day='$day',db1='$takes',scholarship='$scholarship',status='$fname',time='$time',tmk='$paid',ass='16'
,year='$y'";

$query55="update historic set expected_amount='$expected_amounst', amount_paid='$tmss',balance='$balances' where  roll='$roll' and matricule='$matricule' and class='$levels'  and oldb='$takes'  ";
...
echo "<script>alert('Update Recorded Successfully!'); </script>";
 ...
 echo  $statusf="<meta http-equiv='refresh' content='0; url=receiptss.php?usr_name=$matricule' target='blank'>";
