...
<form name="look" method="post" action="getst1v.php?roll=<?php echo $roll;?>&term=<?php echo $term;?>">
...
$term=$_GET["term"];
 $search=$_POST["search"];
$flag=0;
$query="select * from $table  where fname like '%$search%' and db1='$take' and  departmet='$rem' and levels='200'   ";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
		 $flag=1;
