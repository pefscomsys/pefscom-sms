...
$search=$_POST["search"];
$flag=0;
$query="select * from $table  where  db1='$take'  and c110='$ids' and  departmet='$rem' and levels='200'  ";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
		 $flag=1;?><tr ><td font-color=#000><?php echo $row[2];?></td><td><?php echo $row[3];?></td><td><a href='<?php echo $row[1];?>'><?php echo $row[5];?>
