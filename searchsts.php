...
?> <a 
style='text-decoration:none;'  onclick="window.open('page/frombs.php?mats=<?php echo $matricule;?>&rx=<?php echo $db1;?>&ui=<?php echo $row["year1"];?>&dept=<?php echo $department;?>', '_blank', 'location=yes,height=570,width=520,scrollbars=yes,status=yes');">
