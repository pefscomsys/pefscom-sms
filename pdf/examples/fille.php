...
$result=mysql_query($query);
 ...
 $db1=$row['db1'];
	...
	<?php	 
		 ...
		 $form=$_POST["form"];
$query="select * from courses where matricule='$matttt' order by db1 ASC";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
...
<b> </b>
		...
		<?php echo $contact;?>
		  ...
		  <div style="float:left; width:180px; HEIGHT:25PX;border-BOTTOM:1px solid #ccc;border-RIGHT:1px solid #ccc;
		  
		  TEXT-ALIGN:CENTER; FONT-FAMILY:VERDANA;FONT-SIZE:13PX;">
		 
		  <div style="float:left; MARGIN-TOP:5PX;  TEXT-ALIGN:CENTER;width:180px;"> <B>ACADEMIC YEAR</B></DIV>
		  ...
		  <div style="float:left; width:180px; HEIGHT:25PX;border-RIGHT:1px solid #ccc;
...
<?php echo $row['departmet'];  $pt=$row['db1']?>
		 ...
		 <div style="float:left; width:107px;   height:25px;border-right:1px solid #ccc;border-bottom:1px solid #ccc;">
		 LEVEL<?php echo $rttt=$row['levels'];
...
$query3r="update courses set c105='$ui'
...
<b> </b>
		...
		<?php echo $mats=$row['matricule'];  $pt=$row['db1'];?>
		 </div>
...
$query3r="update courses set c106='$ui'
 where matricule='$mats' and departmet='$deptt'and levels='$level'  and db1='$take' ";
...
printf("%01.0f",($ns));?>
			  ...
			  <div style="float:left;font-weight:normal;text-align:center;border-bottom:1px dashed #ccc; width:91px;font-family:arial;height:25px;border-left:1px solid #ccc; ">
...
$query3r="update courses set c107='$ui'
 where matricule='$mats' and departmet='$deptt'and levels>='$level' and levels<='$level'  and db1='$take' ";
...
SIGNATURE OF DEPUTY REGISTRAR I/C ACADEMIC AFFAIRS</b>
 ...
 echo  $statusf="<meta http-equiv='refresh' content='0; url=exemple04.php?roll=$xampp' target='blank'>";
