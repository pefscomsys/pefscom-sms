...
if ($_FILES[csv][size] > 0) { 
    ...
    do { 
        if ($data[0]) { 	
/********************************ADDED BY ME*****************/
		 $check="SELECT * from courses where roll='".addslashes($data[0])."' AND fname= '".addslashes($data[1])."' AND matricule= '".addslashes($data[2])."'AND sex= '".addslashes($data[5])."' AND departmet= '".addslashes($data[3])."'AND levels= '".addslashes($data[4])."' AND db1= '".addslashes($data[6])."' ";
	...
	/*************end added by me********************/	
		...
		$insert="INSERT INTO courses (fname,departmet,levels,matricule,sex,db1,c101,c102,c103,c104,c105,c106,c107,c108,c109,c110) VALUES 
                ( 
                   '".addslashes($data[0])."', 
                    '".addslashes($data[1])."',
					'".addslashes($data[2])."', 
