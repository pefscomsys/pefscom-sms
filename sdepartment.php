...
<ul class="nav nav-pills" style='margin-top:-25px;margin-left:25px;'><a href='dean.php'><button type="button" class="close" aria-label="Close">
  ...
  <div class="panel-heading">
    <h3 class="panel-title"  style='color:white;font-size:21px;'>Select School of interest</h3>
  </div>
 

<?php
 $query="select CAST(facultydesc as text) as school,facultyid  as code from [cg2015].[dbo].[faculty] ";
$result=mssql_query($query);
		 while ($row = mssql_fetch_array($result)) {
?>
