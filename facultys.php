...
<div style="float:left; width:500px;margin-top:15px; height:30px;margin-left:100px;">
			
<select name='amp' id='inputFieldId' autofocus="autofocus" required='required'style="padding:3px;width:420px;"   onchange='this.form.submit()'>
<?php
$mmm=date("m");
$rs=mysql_query("Select * from  faculty where facultyid='$amp'");
...
$query="select * from $pic  where facultyid='$amp'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
?>
...
<div style="float:left; width:50px;text-align:left; height:24px;">
	...
	<a href="newf.php?roll=<?php echo $pic;?>">
&#9658; New <?php echo $pic;?></a>
			</div>
			</div>
