...
<blockquote style='float:left; margin-left:10px;width:65%;height:100px;'>
  <h2>Print Transactions Receipts</h2>
  <small>Showing Transactions and Balances <cite title="Source Title"></cite></small>
</blockquote>
...
<div class="panel panel-default"  style='float:left; width:980px;margin-left:10px; height:450px;'>
  <div class="panel-body">
 <div class="embed-responsive embed-responsive-16by9">
    <iframe class="embed-responsive-item" src="tablesdwasi.php" style='width:980px; height:420px;'></iframe>
  </div>
  </div>
</div>
