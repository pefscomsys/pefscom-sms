...
<blockquote style='float:left; margin-left:10px;width:85%;height:100px;'>
  <h2>Synchronize Semester Result Table Online</h2>
  <small>click on the action bar beside the level of interest <cite title="Source Title"></cite></small>
</blockquote>
...
<div class="panel panel-default"  style='float:left; width:1000px;margin-left:10px; height:410px;'>
 ...
 <div class="embed-responsive embed-responsive-16by9" style=''>
    <iframe class="embed-responsive-item" src="tablesdsssg.php" style='float:left; height:380px; '></iframe>
  </div>
  </div>
</div>
