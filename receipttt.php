...
<body  style="background:url('nn.png');">
<?php
 $mats=$_GET['mat'];
$date=$_GET["date"];$folk=$_GET["afolk"];$fname=$_GET["fname"];$db1=$_GET["db1"]; $db1s=$_GET["db1"];
?><a onclick="window.open('receiptsx.php?mat=<?php echo $mats;?>&date=<?php echo $date;?>&afolk=<?php echo $folk;?>&db1=<?php echo $db1;?>&fname=<?php echo $fname;?>', '_blank', 'location=yes,height=570,width=520,scrollbars=yes,status=yes');">
	CLICK ANY WHERE TO PRINT
...
<div style=" float:left; width:550px; height:40px;text-transform:uppercase;text-align:center; font-size:19px; font-family:
verdana;  background:#ccc;">
...
verdana; color:#000;text-shadow:1px 1px 1px #000; ">


<div style=" float:left; width:450px; height:20px; MARGIN-TOP:-28PX;padding:5px;">
<b><?php echo $school;?></b><br>
	

</div>
<?php echo $website;?>,<?php echo $email;?><br>
		<?php echo $contact;?>
