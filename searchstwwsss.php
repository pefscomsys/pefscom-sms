...
?> <a 
style='text-decoration:none;'  onclick="window.open('tanss.php?mats=<?php echo $matricule;?>&rx=<?php echo $db1;?>&term=<?php echo $x;?>&ui=<?php echo $row["year1"];?>&dept=<?php echo $department;?>', '_blank', 'location=yes,height=570,width=520,scrollbars=yes,status=yes');">
