...
<blockquote style='float:left; margin-left:10px;width:65%;height:100px;'>
  <h2>View Fee by Department <h2>
  <small>Please Department<cite title="Source Title"></cite></small>
</blockquote>
...
<div class="panel panel-default"  style='float:left; width:90%;margin-left:10px; height:450px;'>
 ...
 <div class="embed-responsive embed-responsive-16by9">
    <iframe class="embed-responsive-item" src="tablesdst.php" style='float:left;width:100%; height:420px;'></iframe>
  </div>
  </div>
</div>
