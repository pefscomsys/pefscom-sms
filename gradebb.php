...
<blockquote style='float:left; margin-left:10px;width:65%;height:100px;'>
  <h2>set  Grade Boundary</h2>
  <small>This include the marks,range,and Grade <cite title="Source Title"></cite></small>
</blockquote>

<div style='width:100%;height:300px;'>

<div class="panel panel-default"  style='float:left; width:65%;margin-left:10px; height:300px;'>
  <div class="panel-body">
 <div class="embed-responsive embed-responsive-16by9">
    <iframe class="embed-responsive-item" src="tablesdw.php" style='height:280px;'></iframe>
  </div>
  </div>
</div>
...
<ul class="nav nav-pills" style='margin-top:-25px;margin-left:25px;'><a href='dean.php'><button type="button" class="close" aria-label="Close">
  ...
  <li><a href="#">Add New Grade Range <span class="badge"></span></a></li>
  ...
  <div class="panel-body">
     <?php
  $from1=$_POST["from1"];
  $from2=$_POST["from2"]; $gpa=$_POST["gpa"];$grade=$_POST["grade"];$stat=$_POST["stat"];
   $ids=$_POST["ids"];
...
$query="insert into [cg2015].[dbo].[gradebb] 
(from1,from2,ids,gpa,comments,statuss)
values
('$from1','$from2','$ids','$gpa','$grade','$stat')
...
echo "<script>alert('Grade Range Recorded!'); </script>";

 echo "<meta http-equiv='refresh' content='0; url=gradebb.php'>";
...
mssql_query($query);
  ...
  <div class="form-group"><table width='480px' cellspacing='5'>
  <tr><td style='width:90px;'>
    <label for="exampleInputEmail1">From</label>
    <input type="text" class="form-control" name='from1' style='width:80px;' id="exampleInputEmail1" placeholder="Lower" required='required'></td><td>
    <label for="exampleInputEmail1"  style='width:90px;'>To</label>
    <input type="text" class="form-control" name='from2'  style='width:80px;' id="exampleInputEmail1" placeholder="Upper" required='required'>
	</td>
	<td>
    <label for="exampleInputEmail1"style='width:90px;'>Grade</label>
    <input type="text" class="form-control" name='grade'style='width:80px;' id="exampleInputEmail1" placeholder="A,B,C,D,E,F" required='required'>
	</td>
	<td>
    <label for="exampleInputEmail1">GPA Value</label>
    <input type="text" class="form-control" name='gpa' id="exampleInputEmail1" placeholder="1.5,2" required='required'>
	</td><td>
	  <label for="exampleInputEmail1">Status</label>
    <input type="text" class="form-control" name='stat' id="exampleInputEmail1" placeholder="Fail, Pass , Excellent" required='required'>
	</td>
	</tr></table><br>
  <div class="form-group">
...
?> <option value='<?php echo $row["ids"];?>'><?php echo $row["school"];?></option>
  ...
  <button type="submit" class="btn btn-default" style='width:180px;'>Save</button>
</form>
  </div>
</div>
</div>
