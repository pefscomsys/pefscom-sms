...
'dbc.php'
;?>
<form name="look" method="post" action="mggs.php">
...
$search=$_POST["search"];
$flag=0;
$query="select * from courses where  fname like '%$search%' and db1='$take' and fname>'' order by fname ASC ";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
		 $flag=1;
		 echo "<tr ><td>",$row['fname'],"</td><td><a href='mgm.php?roll=",$row['matricule'],"'>Print id</a></td></tr>";
