...
<div style="float:left; width:650px; height:100px; background:#FFBB40;">	

<form name="form1" action="pastsme.php?roll=<?php echo $fish;?>" method="post" enctype="multipart/form-data" >
