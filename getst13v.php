...
<form name="look" method="post" action="getst13v.php?roll=<?php echo $roll;?>&term=<?php echo $term;?>">
...
$search=$_POST["search"];
$flag=0;
$query="select * from $table  where  db1='$take' and  departmet='$rem' and levels='400' and fname like '%search%' ";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
		 $flag=1;
