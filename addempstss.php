...
$barcodes="$cc$constants$statusfbiomxc161";
...
if(empty($err)) {
$query2="insert into admission2  set  
...
echo "<script>alert('Record Created Successfully!'); </script>";
 ...
 echo  $statusf="<meta http-equiv='refresh' content='0; url=admissionss.php?usr_name=$mats'>";
