...
$search=$_POST["search"];
$flag=0;
$query="select * from courses where  fname like '%$search%'  and fname>''  limit 9 ";
$result=mysql_query($query);
$i=0;
 while ($row = mysql_fetch_array($result)) {
if($i%2==0)
...
<td><?php echo $row["matricule"]; ?> <?php echo $row["levels"]; ?><?php echo $row["db1"]; ?></td>
<td><?php echo $row["fname"]; ?></td>
<td><?php echo $row["departmet"]; ?></td>
<td>
<a href="ino.php?roll=<?php echo $row["roll"]; ?>">Repeat Class</a></td>
<td>
