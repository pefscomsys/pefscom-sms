...
<form name="look" method="post" action="petchsss.php">
<table style=" border:1px solid silver" cellpadding="5px" cellspacing="0px" align="center" border="0" width="400px">
<tr>
<td colspan="4" style=" color:#000; font-size:20px; background:#ffcc00;">Search - student Result slip/  recherche  
la Résultats de étudiante </td>
</tr>
<tr>
<td>
<div class="content">
...
<td style="color:#fff">Name of student / Nom de étudiante </td>
<td style="color:#fff">Form</td>
<td style="color:#fff">Matricule/ Matricule</td>
