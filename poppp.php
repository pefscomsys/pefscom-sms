...
?>
						...
						<tr><td style="border-bottom:1px solid #000;">Comment</td><td style="border-bottom:1px solid #000;"></td></tr>	
					
						<tr><td style="border-bottom:1px solid #000;">Phone</td><td style="border-bottom:1px solid #000;color:#999;"><?php echo $row["phone"];?></td></tr>	
					
						<tr><td style="border-bottom:1px solid #000;">Fax</td><td style="border-bottom:1px solid #000;color:#999;"><?php echo $row["fax"];?></td></tr>	
					
						<tr><td style="border-bottom:1px solid #000;">E-mail</td><td style="border-bottom:1px solid #000;color:#999;"><?php echo $row["email"];?></td></tr>	
...
<div style="float:left; width:650px; height:127px;font-size:14px;margin-top:1px;">		
	...
	<a href="newf.php?roll=<?php echo $sec;?>&kill=<?php echo $roll;?>">
