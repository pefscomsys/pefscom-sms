...
<ul class="nav nav-pills" style='margin-top:-25px;margin-left:25px;'>
  ...
  <li><a href="#" style='background:#efefef;'>Unread Assignments <span class="badge">3</span></a></li>
  
  <li><a href="#" class="active" style='background:#efefef;'>Total Balance Fee Owed <span class="badge">3</span></a></li>
  
  
  <li><a href="#" class="active" style='background:#efefef;'>Total Male<span class="badge">3</span></a></li>
  
  <li><a href="#" class="active" style='background:#efefef;'>Bank Transaction<span class="badge">3</span></a></li>
</ul>
...
<blockquote style='float:left; margin-left:10px;width:65%;height:100px;'>
  <h2>Add New Faculty/School</h2>
  <small>Create New Faculty<cite title="Source Title"></cite></small>
</blockquote>

<div style='width:105%;height:300px;'>

<div class="panel panel-default"  style='float:left; width:60%;margin-left:10px; height:300px;'>
  <div class="panel-body">
 <div class="embed-responsive embed-responsive-16by9">
    <iframe class="embed-responsive-item" src="tablesdg.php" style='height:280px;'></iframe>
  </div>
  </div>
</div>
...
<div   style='float:left; width:400px;margin-left:10px; height:300px;'>


<ul class="nav nav-pills" style='margin-top:-85px;margin-left:25px;'><a href='dean.php'><button type="button" class="close" aria-label="Close">
  <span aria-hidden="true">&times; close</span>
</button></a>
  <li class="active"><a href="#" style='color:#fff;'><span class="badge">Add</span></a></li>
  <li><a href="school.php">A Mother Institution<span class="badge"></span></a></li>
  ...
  $facc=$_POST["facc"];
   $facid=$_POST["facid"];$schoolid=$_POST["schoolid"];$confered=$_POST["confered"];$proposed=$_POST["propose"];
  if(empty($faculty)){
...
$query="insert into [cg2015].[dbo].[faculty] 
(facultyid,schoolid,facultyof,facultydesc,code,contact,web,email,propose,confered)
values('$facid','$schoolid','Faculty of',' $faculty','$facc','$contact','$web','$email','$proposed','$confered')
...
echo "<script>alert('Faculty Created!'); </script>";
 ...
 echo "<meta http-equiv='refresh' content='0; url=faculty.php'>";
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name='faculty' id="exampleInputEmail1" placeholder="New Faculty" required='required'>
	
    <label for="exampleInputEmail1">Faculty Constant</label>
    <input type="text" class="form-control" name='facc' id="exampleInputEmail1" placeholder="Faculty Constant"  required='required'>
	
	
    <label for="exampleInputEmail1">Select School of Interest</label> <div >
        <select class="form-control" name='schoolid'id="select">
         
<?php
 $query="select CAST(ids as text) as ids,CAST(school as text) as school from [cg2015].[dbo].[school]";
$result=mssql_query($query);
		 while ($row = mssql_fetch_array($result)) {
?> <option value='<?php echo $row["ids"];?>'><?php echo $row["school"];?></option>
  ...
  <div class="form-group">
    <label for="exampleInputPassword1">Faculty  ID</label>
      <div >
       
    <input type="text" class="form-control" name='facid' id="exampleInputEmail1" value="<?php 
...
$row = mssql_fetch_assoc($qry); 
 ...
 ?>" placeholder="Faculty/School Constant"readonly>
