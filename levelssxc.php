...
<title><?php echo $school;?></title>
	...
	<a href="sitp.php?roll=<?php echo $rem;?>&term=<?php echo $_GET["term"];?>">
...
100 LEVEL
	...
	<div style="float:left; width:208px;text-align:center; height:57px; background:url(age.png); font-family:impact;">
	<a href="sit.php?roll=<?php echo $rem;?>&term=<?php echo $_GET["term"];?>">
	<div style="float:left; width:208px; margin-top:10px;">
200 LEVEL
	...
	<div style="float:left; width:92px; margin-top:10px;"></div>
		...
		<div style="float:left; width:208px;text-align:center; height:57px; background:url(age.png); font-family:impact;">
	<a href="sit2.php?roll=<?php echo $rem;?>&term=<?php echo $_GET["term"];?>">
	<div style="float:left; width:208px; margin-top:10px;">
300 LEVEL
	...
	<div style="float:left; width:92px; margin-top:10px;"></div>
		...
		<div style="float:left; width:208px;text-align:center; height:57px; background:url(age.png); font-family:impact;">
	<a href="sit3.php?roll=<?php echo $rem;?>&term=<?php echo $_GET["term"];?>">
	<div style="float:left; width:208px; margin-top:10px;">
400 LEVEL
