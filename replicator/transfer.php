...
<div id="popup">
<div class="row" >
  <div class="col-md-3" style='width:85%;height:550px;margin-top:15px;'>
<blockquote style='float:left; margin-left:10px;width:85%;height:100px;'>
  <h2>Synchronize Changes Made on Course for a Student</h2>
  <small>click on the action bar beside the course of interest <cite title="Source Title"></cite></small>
</blockquote>
...
<div class="panel panel-default"  style='float:left; width:1050px;margin-left:10px; height:410px;'>
  <div class="panel-body">
 <div class="embed-responsive embed-responsive-16by9" style=''>
    <iframe class="embed-responsive-item" src="tablesdss.php" style='float:left; height:380px; '></iframe>
  </div>
  </div>
</div>
