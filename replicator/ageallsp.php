...
<div style="float:left; width:100px; height:80px;color:#fff;font-size:22px;"><div style="float:left;margin-top:5px;margin-left:5px;">&#9658;</div></div>
 <div style="float:left; width:500px;color:#1188aa; height:30px;font-size:28px;color:#fff;">Level : <?php echo $ms;?>, Dept: <?php echo $dept;?></div></div>
...
?><?php } ?>
			...
			<table width="450px" cellpadding="4" style="margin-left:70px;">
...
<td style="float:left;text-align:left;"></td>
<td style="float:left;text-align:left;"><a href="sync-mysql4.php?levels=<?php echo $ms;?>&db1=<?php echo $db1;?>&dept=<?php echo $dept;?>&sex=1">
Semester 1   <?php echo $dept;?></a>	
					</td></tr>
...
<td style="float:left;text-align:left;"></td>
<td style="float:left;text-align:left;"><a href="sync-mysql4.php?levels=<?php echo $ms;?>&db1=<?php echo $db1;?>&dept=<?php echo $dept;?>&sex=2">
Semester 2  <?php echo $dept;?></a>	
					</td></tr>
...
<td style="float:left;text-align:left;"></td>
<td style="float:left;text-align:left;"><a href="sync-mysql4.php?levels=<?php echo $ms;?>&db1=<?php echo $db1;?>&dept=<?php echo $dept;?>&sex=3">
Semester 3  <?php echo $dept;?></a>	
					</td></tr>
