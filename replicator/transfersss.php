...
<div style="float:left; width:100px; height:80px;color:#fff;font-size:22px;"><div style="float:left;margin-top:5px;margin-left:5px;">&#9658;</div></div>
 <div style="float:left; width:500px;color:#1188aa; height:30px;font-size:28px;color:#fff;">FINANCE TRANSFER SECTION</div></div>
...
<?php
$query="select * from historic group by oldb";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
?>
...
<td style="float:left;text-align:left;"><a href="sync-mysql6.php?roll=<?php echo $row["oldb"];?>">
<?php echo $row["oldb"];?></a>	
					</td></tr>
