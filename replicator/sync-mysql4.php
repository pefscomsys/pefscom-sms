...
mysql_select_db($db[1], $mr1);
  ...
  mssql_select_db($db[2], $mr2);
    ...
    $q2 = "DELETE  FROM [cg2015].[dbo].[resit] where db1='$db1'  and levels='$levels' and departmet='$dept'and sex='$sex'	";
    ...
    $q2 = "SELECT * FROM [cg2015].[dbo].[resit] where db1='$db1' and levels='$levels' and departmet='$dept' and sex='$sex'";
    ...
    for ($x=0; $x<$n2; $x++) {
      ...
      foreach ($w2 as $key => $val) {
        ...
        $st .= "'".mysql_real_escape_string($val)."'";
	      ...
	      echo $q3 = "INSERT INTO [cg2015].[dbo].[resit] VALUES ($st)";
