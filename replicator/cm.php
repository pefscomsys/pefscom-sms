...
<div style="float:left; width:100px; height:80px;color:#fff;font-size:22px;"><div style="float:left;margin-top:5px;margin-left:5px;">&#9658;</div></div>
 <div style="float:left; width:500px;color:#1188aa; height:30px;font-size:28px;color:#fff;">Level : <?php echo $ms;?></div></div>
...
<?php
$query="select * from matsub group by mgg";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
?>
...
<td style="float:left;text-align:left;"><a href="cmm.php?roll=<?php echo $ms;?>&dept=<?php echo $row["mgg"];?>&pic=<?php echo $row["mgg"];?>&uii=<?php echo $uii;?>">
<?php echo $row["mgg"];?></a>	
					</td></tr>
