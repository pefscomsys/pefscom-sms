...
<div style="float:left; width:100px; height:80px;color:#fff;font-size:22px;"><div style="float:left;margin-top:5px;margin-left:5px;">&#9658;</div></div>
 <div style="float:left; width:500px;color:#1188aa; height:30px;font-size:28px;color:#fff;">Create Course for New Accademic Year!</div></div>
...
<?php
$query="select * from courses group by db1";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
?>
...
<td style="float:left;text-align:left;"><a href="uall.php?rollx=<?php echo $row["db1"];?>&pic=<?php echo $row["db1"];?>">
<?php echo $row["db1"];?></a>	
					</td></tr>
