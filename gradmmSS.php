...
$semester="1";$fc="(c101+c102)>'0.1'and (c101+c102)<='39.99'";
$sex2="1";$ef="FIRST SEMESTER";
$dc="(c101+c102)>='0.1'and (c101+c102)<='49.999'";
$gc="(c101+c102)>='40'and (c101+c102)<='44.99'";$rts="(c101+c102)>='45'and (c101+c102)<='49.99'";
} elseif($mxc11s>="2" && $mxc11s<="2"){
$semester="2";
$sex2="2";$ef="SECOND SEMESTER";$fc="(c101+c102)>'0.1'and (c101+c102)<='39.99'";
$dc="(c101+c102)>='0.1'and (c101+c102)<='49.999'";
$gc="(c101+c102)>='40'and (c101+c102)<='44.99'";$rts="(c101+c102)>='45'and (c101+c102)<='49.99'";
...
$semester="1";
$sex2="3";$ef="FIRST SEMESTER RESIT";$fc="(c101+c102)>'0.1'and (c101+c102)<='39.99'";
$dc="(c101+c102)>='45' and (c101+c102)<='49.999'";
$gc="(c101+c102)>='40' and (c101+c102)<='44.99'";
$rts="(c101+c102)>='45'  and (c101+c102)<='49.99'";

}  elseif($mxc11s>="4" && $mxc11s<="4"){
$semester="2";
$sex2="3";$ef="SECOND SEMESTER  RESIT";
$dc="(c102)>'0.1' and (c101+c102)<='49.999'";
$fc="(c102)>'0.1'and (c101+c102)<='39.99'";$gc="(c102+c101)>='40' and (c101+c102)<='44.99'";
$rts="(c101+c102)>='45'  and (c101+c102)<='49.99'";
}
 ?>
...
<table cellspacing="$semester" cellpadding="2"class="gridtable" style="width:1000px;border-collapse: collapse; border-bottom-width: 0px; border-right-width: 0px;color:#000;"><tr style="background-color: #EEEEEE;">
...
from resit where  departmet='$department' and levels='$levels' and sex='$sex2' and db1='$take' and fname='$code' and  (c101+c102)>='' and matricule>''");
...
<td><?php
$qry = mysql_query("select * 
from resit where  departmet='$department' and levels='$levels' and sex='$sex2' and db1='$take' and fname='$code' and  (c102)>'0' and matricule>''");
