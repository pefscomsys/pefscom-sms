...
<div style="float:left;margin-top:5px;margin-left:5px;">&#9658;</div>
 ...
 <div style="float:left; width:400px;color:#1188aa; height:30px;font-size:22px;color:#fff;text-transform:uppercase;"><?php echo $pic;?></div>
 
 <p> Please Type in the Name (and Hit Enter then check the box against the name then click update to update or delete to erase)
 
		
<iframe title="" class="youtube-player" type="text/html" 
width="100%" height="400" src="changedep.php"
