...
?> <a 
style='text-decoration:none;'  onclick="window.open('updatess.php?mats=<?php echo $matricule;?>&rx=<?php echo $db1;?>&levels=<?php echo $year1;?>&ui=<?php echo $row["year1"];?>&dept=<?php echo $department;?>', '_blank', 'location=yes,height=570,width=800,scrollbars=yes,status=yes');">
