...
background:url(Tulips.jpg);
	...
	<a href="changes200x.php?roll=<?php echo $mmj;?>">
...
Change 200 level
	...
	<div style="float:left; width:208px;text-align:center; height:37px; background:#efefef; font-family:impact;">
	<a href="changesub201x.php?roll=<?php echo $mmj;?>">
	<div style="float:left; width:208px; margin-top:10px;">
Change 300 level
	...
	<div style="float:left; width:208px;text-align:center; height:37px; background:#efefef; font-family:impact;">
	<a href="changesub204x.php?roll=<?php echo $mmj;?>">
	<div style="float:left; width:208px; margin-top:10px;">
Change 400 level
	...
	<div style="float:left; width:208px;text-align:center; height:37px; background:#efefef; font-family:impact;">
	<a href="changesub205x.php?roll=<?php echo $mmj;?>">
	<div style="float:left; width:208px; margin-top:10px;">
Change 500 level
	...
	<div style="float:left; width:208px;text-align:center; height:37px; background:#efefef; font-family:impact;">
	<a href="changesub206x.php?roll=<?php echo $mmj;?>">
	<div style="float:left; width:208px; margin-top:10px;">
Change 600 level
	...
	<div style="float:left; width:208px;text-align:center; height:37px; background:#efefef; font-family:impact;">
	<a href="changesub207x.php?roll=<?php echo $mmj;?>">
	<div style="float:left; width:208px; margin-top:10px;">
Change 700 level
