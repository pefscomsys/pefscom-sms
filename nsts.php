...
mssql_query ($query1) or die ('could not updated:'.mssql_error());
 ...
 echo  $statusf="<meta http-equiv='refresh' content='0; url=excell/indexs.php?name=$name1'>";
}
}
}
...
<h2> Upload Exam Marks Only</h2>
<small> This sheet should have only exam marks</small>
