...
<?php
$roll=$_GET["1"];
$query="select * from gradebb where extra='1' and ids='$ids'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
?>
...
<?php
$roll=$_GET["1"];
$query="select * from gradebb where extra='2'and ids='$ids'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
?>
...
<?php
$roll=$_GET["1"];
$query="select * from gradebb where extra='3' and ids='$ids'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
?>
...
<?php
$roll=$_GET["1"];
$query="select * from gradebb where extra='4' and ids='$ids'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
?>
...
<?php
$roll=$_GET["1"];
$query="select * from gradebb where extra='5' and ids='$ids'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
?>
...
<?php
$roll=$_GET["1"];
$query="select * from gradebb where extra='6' and ids='$ids'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
?>
...
<?php
$roll=$_GET["1"];
$query="select * from gradebb where extra='7' and ids='$ids'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
?>
...
<?php
$roll=$_GET["1"];
$query="select * from gradebb where extra='8' and ids='$ids'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
?>
...
<?php
$roll=$_GET["1"];
$query="select * from gradebb where extra='9' and ids='$ids'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
?>
...
$form=$_POST["form"];
$query="select * from $table where db1='$take' and fname='$fname' and c110='$ids' order by levels ASC";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
		 ...
		 <B>ST. FRANCIS HIGHER INSTITUTE OF NURSING AND MIDWIFERY<BR>
		 ...
		 <div style="float:left; width:460px; height:100px;LINE-HEIGHT:21PX;FONT-FAMILY:TIMES;">
		 RESULT SLIP FOR-  <?PHP ECHO $deptt=$row["departmet"];?><BR>
		 FIRST SEMESTER EXAMS
		 <BR>LEVEL: <?php echo $level=$row["levels"];?><br>
		 ...
		 <div style="float:left; width:200px; height:222px;BORDER:1PX SOLID #000;font-family:arial; font-size:13px;">
		 
		 <div style="float:left; width:200px; height:35px;BORDER-BOTTOM:1PX SOLID #000;">
...
$query = mysql_query("select  * from resit where db1='$take' and matricule='$mats' and departmet='$deptt' and c110='$ids'and sex='1' and levels='$level'order by fname ASC"); 
...
from resit where matricule='$mats' and departmet='$deptt'and levels='$level' and sex='1' and db1='$take' and c110='$ids'  "); 
$row = mysql_fetch_assoc($qry); 
$save=$row['total']; 
...
$queryf3="update courses set c103='$statusfbio'
...
$qry = mysql_query("select * FROM resit where departmet='$deptt' and levels='$level' and matricule='$mats' and db1='$take' and fname>'' and sex='1' "); 
$num_rows=mysql_num_rows($qry);
  $totalstudent=$num_rows; 

$qry = mysql_query("select * FROM resit where departmet='$deptt' and levels='$level' and matricule='$mats' and db1='$take' and fname>'' and sex='1' and (c101+c102)>=50"); 
$num_rows=mysql_num_rows($qry);
  $passed=$num_rows;
