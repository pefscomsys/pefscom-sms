...
<form name="look" method="post" action="unistt.php"   >           <div  class="btn btn-success"  style="color:#FFFFFF;">
Graduation List
</div>
...
$rs=mssql_query("Select CAST(classs as text) as classs from [cg2015].[dbo].[classes]  ",$link);
