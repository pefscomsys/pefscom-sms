...
<tr class="listheader">
<td></td>
<td>Enter Search Keyword</td><td><input type="text" name="search" size="29"placeholder="name #"style="float:left; width:200px; height:28px;" /></td>
<td><input type="submit" value="Search"  style="float:left; width:140px; height:28px;"/></td>
<td></td>
</tr>
...
<td>
<a href="editcpermission.php?roll=<?php echo $row["matricule"]; ?>">Permission</a></td>
