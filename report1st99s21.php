...
$form=$_POST["form"];
$query="select * from $table where roll='$rolls'  ";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
		 ...
		 <img src="logo.png" width="100px" height="100px" >
		  ...
		  <div style="float:left;FONT-SIZE:18PX; width:450px;margin-top:0px;font-family: ‘Times New Roman’, Times, serif;  height:100px; ">
		 ...
		 <div style="float:left;FONT-SIZE:14PX; width:3450px; HEIGHT:21PX;">
<?php echo $school6b;?>
		 
		 </div> 
		 <div style="float:left;FONT-SIZE:14PX; width:420px; HEIGHT:21PX;">
...
ACADEMIC YEAR :<?php echo $take;?>
		  ...
		  <div style="float:left; width:800px;margin-top:20px; border:1px solid #000; text-align:center;height:30px;font-size:18px;text-transform:uppercase;"><?php $term=$_GET["term"];
