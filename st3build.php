...
<div style="float:left;margin-top:5px;margin-left:5px;">&#9658;</div>
 ...
 <div style="float:left; width:450px;color:#1188aa; height:30px;font-size:22px;color:#fff;text-transform:uppercase;">Adding Missing Course On Result Slip</div>
...
width="100%" height="400" src="stm.php"
