    ...
    <div class="w2ui-page page-0">
        <div style="width: 580px; float: left; margin-right: 0px;">
            ...
            <div class="w2ui-group" style="height: auto;">
                ...
                <option value="5000">Packet or Form</a></option>
                <option value="27500">Registration</option>
				
                <option value="30000">Btech Registration</option>
				</select>
                    </div>
                </div>
				<div class="w2ui-field w2ui-span4">
                    <label>Part Tution</label>
                    <div>
                        <input name="part" type="text" maxlength="100" placeholder="amount only"style="width: 100%">
                    </div>
                </div>
            </div>
        </div>
