...
if(empty($mxccredit)){
 $colorf1bio="yellow";
 $statusfbiocredit="";$statusfbiocredit='0';}
elseif($mxccredit<50){
...
from gpax where matricule='$mats' and departmet='$deptt'  and  fname='$courseps' "); 
$row = mysql_fetch_assoc($qry); 
 $xdfs=$row['total']; 
...
$query33x="update gpax set c101='$cas',c102='$exam',c104='$richooTTTy',c103='$statusfbio' where
