...
$mxx=$manka;
if(empty($mxx)){}
elseif($mxx>=100 && $resit>=50  &&  $resit<=100 ){
$tk=($manka/2);}
elseif($mxx<100  && $resit>=50  &&  $resit<=100){
$tk=50;
...
$qry = mysql_query("select  SUM(c101+c102) as total
from 
resit where matricule='$mats'and fname='$courseps'   and (c101+c102)>''
"); 
$row = mysql_fetch_assoc($qry); 
...
$num_rows=mysql_num_rows($qry);
 ...
 $mxy=$ss;
if(empty($mxy)){}
elseif($mxy>=50 && $mxy<=100){
 $tk=$ss;

}


elseif($mxy>=50 && $mxy<=100 && $x>=1  &&  $x<=1 ){
 $tk=$ss;

}

elseif($mxy<50 && $x>=1  &&  $x<=1 ){
 $tk=$ss;

}elseif($mxy>=50  && $mxy<=100 && $x>=2  &&  $x<=2 ){
 $tk=$ss;

}
elseif($mxy<50 && $x>=2  &&  $x<=2 ){
 $tk=50;
...
elseif($mxy>=50 && $mxy<=100 && $x>=3  &&  $x<=3 ){
 $tk=$ss;

}elseif($mxy<50 && $x>=3  &&  $x<=3 ){
 $tk=50;
...
$query4="insert into gpas  set  matricule='$mats',credit='$richooTTTy',levels='$level',db1='$pt'
 ,gpav='$statusfbiogff',code='$courseps',sex='2' ,cc='$tk' ,tm='$cc',mark='$ns',ee='$ee'";
