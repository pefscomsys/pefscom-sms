...
<div style="float:left;  width:550px; height:78px;border-bottom:1px solid green;">


<div style="float:left;  width:400px; TEXT-ALIGN:CENTER;height:78px; margin-left:60px; margin-top:10px;">

<div id="coh1"style="font-size:17px;"><b>PEFSCOM COMPANY LTD</b></div>

<div id="coh1"style="COLOR:rgb(20,50,100);margin-left:2px; font-size:17px;margin-top:-10px;font-weight:normal;text-align:center;">Premium Enterprise For Software  Configuration<br>
 of Manual System </div>


</div>

<div style="float:left;  width:130px; border-bottom:3px solid rgb(10,50,100); height:97px; margin-left:-50px; margin-top:7px;">
<img src="logo.jpg" width="120px" height="65px">
</div>
...
<div style="float:left; margin-top:0px; margin-left:-20px;width:550px;text-align:center; font-size:18px;COLOR:#1188aa; letter-spacing:2px; height:15px;">

<div style="float:left; margin-top:-13px;width:550px;margin-left:20px;"> 
<B style="COLOR:red;">STAFF CARD</B>
</div></div>
...
<img src="load_image.php?pic_id=<?php echo $savep4;?>" width="120px" height="80px"style="border:1px solid #1188aa; margin-top:10px; margin-left:-25px;">
...
<div style="float:left;  width:550px; margin-top:-120px; height:65px;background:rgb(190,30,50);text-align:center;">
...
<div style="float:left;margin-left:0px;margin-top:-80px;">
<?php
 $matricule=$barcode;
$default_value = array();
