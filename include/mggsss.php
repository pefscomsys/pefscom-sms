...
<img src="load_image.php?pic_id=<?php echo $savep4;?>" width="70px" height="60px"style="border:1px solid #efefef; margin-top:20px;">
...
from admission where matricule='$mat' and extra='$levels'   "); 
$row = mysql_fetch_assoc($qry); 
echo $save=$row['total']; 
?>
</div>
...
<img src="load_image.php?pic_id=<?php echo $savep4;?>" width="130px" height="110px"style="border:1px solid #1188aa; margin-top:10px; margin-left:-25px;">
...
<div style="float:left;  width:550px; margin-top:-120px; height:65px;background:rgb(10,50,100);text-align:center;">
