...
<div style="float:left;margin-top:5px;margin-left:5px;">&#9658;</div>
 ...
 <div style="float:left; width:450px;color:#1188aa; height:30px;font-size:22px;color:#fff;text-transform:uppercase;">Print Reciepts</div>
...
width="100%" height="530" src="pintrss.php?usr_name=<?php echo $fnamej;?>"
