...
<form name="look" method="post" action="frequency.php"   >           <div  class="btn btn-success"  style="color:#FFFFFF;">
...
<?php
$rs=mssql_query("Select  sems,CAST(db1 as text) as classs from [cg2015].[dbo].[x]  ",$link);
	  while($row=mssql_fetch_array($rs))
{
if($row[1]==$fees)
{
