...
mssql_select_db($db[1], $mr1);
  ...
  echo mysql_error($mr2);
    ...
    $q2 = "SELECT   fname, matricule, departmet, levels, sex, db1, c101, c102, c103, c104, c105, c106, c107, c108, c109, c110,roll FROM resit ";
    ...
    for ($x=0; $x<$n2; $x++) {
      ...
      foreach ($w2 as $key => $val) {
        ...
        $st .= "'".mysql_real_escape_string($val)."'";
	      ...
	      echo $q3 = "INSERT INTO resit  (  fname, matricule, departmet, levels, sex, db1, c101, c102, c103, c104, c105, c106, c107, c108, c109, c110,roll)      VALUES ($st)";
