...
<div id="popup">
<div class="row" >
  <div class="col-md-3" style='width:100%;height:650px;margin-top:15px;'>
...
<div class="panel panel-default"  style='float:left; width:60%;margin-left:10px; height:300px;'>
 ...
 <div class="embed-responsive embed-responsive-16by9">
    <iframe class="embed-responsive-item" src="tablesd.php"  style='height:280px;'></iframe>
  </div>
  </div>
</div>
...
<ul class="nav nav-pills" style='margin-top:-25px;margin-left:25px;'><a href='dean.php'><button type="button" class="close" aria-label="Close">
  ...
  <li><a href="faculty.php">New Faculty/School <span class="badge"></span></a></li>
  ...
  $depc=$_POST["depc"]; $fees=$_POST["fees"];$afees=$_POST["afees"];
  $confered=$_POST["confered"]; $proposed=$_POST["proposed"]; $duration=$_POST["duration"];
   $facid=$_POST["facid"];
...
$qry = mssql_query("select schoolid as total
from [cg2015].[dbo].[faculty] where facultyid='$facid'  "); 
$row = mssql_fetch_assoc($qry); 
 $schoolid=$row['total'];
$query="insert into [cg2015].[dbo].[classes] 
(classs,code,ids,fees,area,deptf,confered,propose,[level])
values
('$department','$depc','$facid','$fees','$afees','$schoolid','$confered','$proposed','$ppp0s')
...
echo "<script>alert('department Created!'); </script>";
 ...
 echo "<meta http-equiv='refresh' content='0; url=newf.php'>";
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name='department' id="exampleInputEmail1" placeholder="New Department" required='required'>
    <label for="exampleInputEmail1">Department Constant</label>
    <input type="text" class="form-control" name='depc' id="exampleInputEmail1" placeholder="Department Constant" required='required'>
   <label for="exampleInputEmail1">Diploma/Degree Conferred</label>
    <input type="text" class="form-control" name='confered' id="exampleInputEmail1" placeholder="Diploma/Degree Conferred"  required='required'>
	<label for="exampleInputEmail1">Diploma/Degree proposed</label>
    <input type="text" class="form-control" name='proposed' id="exampleInputEmail1" placeholder="Diploma/Degree proposed"  required='required'>
	 <label for="exampleInputEmail1">Expected Departmental Fee</label>
    <input type="text" class="form-control" name='fees' id="exampleInputEmail1" placeholder="Fee" required='required'>
	
    <label for="exampleInputEmail1">Application Fee</label>
    <input type="text" class="form-control" name='afees' id="exampleInputEmail1" placeholder="Application Fees" required='required'>
 <label for="exampleInputEmail1">Start Level</label>
     <select class="form-control"name='slevel' id="select">
         <?php
 $query="select CAST(levels as text) as school from [cg2015].[dbo].[levels] where levels!='100'";
$result=mssql_query($query);
		 while ($row = mssql_fetch_array($result)) {
...
<label for="exampleInputEmail1">Duration in years</label>
    <input type="text" class="form-control" name='duration' id="exampleInputEmail1" placeholder="e.g 2" required='required'>
  ...
  <div class="form-group">
    <label for="exampleInputPassword1">Select Faculty/School</label>
      <div >
        <select class="form-control"name='facid' id="select">
         <?php
