...
<body onload='windows.print()'>
		<a onclick="window.open('uniss.php?levels=<?php echo $levels;?>&department=<?php echo $department;?>&db1=<?php echo $db1;?>&S=<?php echo $semesters;?>', '_blank', 'location=yes,height=570,width=520,scrollbars=yes,status=yes');">
