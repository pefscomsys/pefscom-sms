...
CAST(sex as text) as sex, CAST(db1 as text) as db1
 ...
 from [cg2015].[dbo].[courses] where matricule='$rolls'  and levels='$levels'  and db1='$rx'  and departmet='$dept' and c110='$id'
 
  group by matricule,fname,levels,c110,departmet,sex,db1,cxx2";
...
?> </td><td style='font-weight:bold; font-size:18px;width:340px;'>&nbsp;</td><td style='font-weight:bold; font-size:18px;'><?php echo $semsss2;?><?php echo $save;?></TD></tr>
