...
$fname=$_POST["fname"];
$query="select * from $table where db1='$take' and fname='$fname'  and c139='1' and cxx5='$cxx5' order by levels ASC";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
...
$query4e="update courses set c129='$ui' where departmet='$deptt' and levels='$level' and db1='$take'and matricule='$mats' ";
