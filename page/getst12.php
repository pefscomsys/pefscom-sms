...
<form name="look" method="post" action="getst12.php">
...
$search=$_POST["search"];
$flag=0;
$query="select * from $table  where  db1='$take' and c110='$ids'and  departmet='$rem' and levels='300' AND  fname like '%$search%' ORDER BY fname ASC ";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
		 $flag=1;
