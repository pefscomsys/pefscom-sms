...
<br>
<br>
<form name="update" method="post" action="printxx11P.php">
...
<table style=" border:1px solid silver ; background:#fff; color:#000; font-size:12px;" cellpadding="10px" bgcolor="#fff"cellspacing="0px" align="center" border="0">
   ...
   <tr>
	...
	<input type="hidden" name="matricule" size="10" value="<?php echo $row['matricule'];?>">
	<input type="hidden" name="roll" size="10" value="<?php echo $row[0];?>">
    ...
    <tr>
      <td>Matri :</td>
      <td><?PHP ECHO $matricule=$row['matricule'];?></td></tr>
