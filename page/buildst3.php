...
echo "<script>alert('Data Base Updated Successful!'); window.location.href('marks.php');</script>";
 ...
 echo $statusftydate="<meta http-equiv='refresh' content='0; url=stm.php'>";
 }
?>		
...
<input type="TEXT" name="levels[]" style="background:#ccc;"value="<?php echo $levels; ?>" size="8">
	<input type="TEXT" name="ddd[]"style="background:#ccc;" value="<?php echo $db1; ?>" size="8">
