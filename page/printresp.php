...
<div style="margin-left:100px; margin-top:50px; float:left; width:700px; height:480px;bcakground:('fm.png');">
...
$qry = mysql_query("select * FROM  balancesheet2 where db1='$take'  "); 
$num_rows=mysql_num_rows($qry);
  $nn=$num_rows; 
...
$result=mysql_query($query);
		 ...
		 border-right:1px solid #000;border-left:1px solid #000; height:25px; font-family:arial;
		 font-size:13px;'>
<div  style='float:left; width:150px; border-right:1px solid #000; height:25px;'>$num_rows</div>
<div  style='float:left; width:280px; height:25px; border-right:1px solid #000;'>


",$row[2],"</div><div  style='float:left; width:100px; height:25px;'>$tol</div>
...
from asourd where matricule='$mats'"); 
$row = mysql_fetch_assoc($qry); 
echo $row['total']; 
?></b> frs C.F.A</div>
...
<div style="margin-left:0px; margin-top:150px; float:left; width:700px; height:480px;bcakground:('fm.png');">
