...
from resit where fname='$subject' and  sex='3'  and db1='$take' and  departmet='$department'"); 
$row = mysql_fetch_assoc($qry); 
   $ma=$row['total'];
...
if(empty($mxc11UIS)){
 ...
 $stat="resit";
 $stats="levels='$levelst' and db1='$take' and departmet='$deps'  and fname='$subject' and (c102+c101<50) and matricule>''order by matricule  ASC";
$c10e=$c111;
...
elseif($mxc11UIS>'' ){
 $stat="resit";
 $stats="levels='$levelst' and db1='$take' and departmet='$deps' and sex='3' and fname='$subject' and (c102+c101<50) and matricule>'' order by matricule  ASC";
$c10e="c102";
}
...
$row = mysql_fetch_assoc($qry); 
 ...
 ?>
		...
		<?php echo $matricule;?>
		  ...
		  <td style="width:70px;height:25px;padding:3px;border-bottom:1px solid #000;">
		<input type="text" name="c101[]" id="name_1"value="<?php echo $c101;?>" readonly='readonly' size="6" style="padding:5px;border-bottom:1px solid #000;"/>
		</td>
	
           
    <td style="width:70px;height:25px;padding:3px;border-bottom:1px solid #000;">
		<input type="text" name="c102[]" id="description_1" value="<?php echo $$c10e;?>" Placeholder="Enter Exam Mark"size="9"style="padding:5px;border-bottom:1px solid #000;"  />
		</td>
 ...
 <input type='hidden' name='sex[]' value='3' size='8' style='BACKGROUND:#CCC;' maxlength='4'>
