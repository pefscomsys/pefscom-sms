...
$query="select * from certificate where roll='$rollsps' limit 1
";
...
<?php
$query="select * from courses where roll='$rollsps' limit 1
";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
		...
		<div style="float:left; width:1408px; margin-left:-60px;height:965px; MARGIN-TOP:-80PX;  BACKGROUND:URL(report.png); font-family:times;">
		 ...
		 <div style="float:left;font-family:arial; width:323px; MARGIN-TOP:20PX;height:120px;letter-spacing:1px;TEXT-ALIGN:CENTER; MARGIN-LEFT:5PX;">
<b style="font-size:18px;">
		HIGHER INSTITUTE OF MANAGEMENT STUDIES <?php echo $takes2;?> <BR><?php echo $school7;?> <?php echo $school7b;?> </b>
		...
		Contact: (00237) 67982 1672 / 6963 68834
		 ...
		 <div style="float:left; width:323px; height:140px; color:#000; ">
			 ...
			 <div style="float:left;font-size:18px; width:320px; MARGIN-TOP:50PX;font-weight:bold;height:50px;TEXT-ALIGN:CENTER; MARGIN-LEFT:5PX;">
STUDENT ACADEMIC RECORD
		  ...
		  <div style="float:left;border-bottom:1px solid #000; width:719px; height:70px; color:#000; ">
			 ...
			 <div style="float:left; width:249px;font-size:18px; height:34px;color:#000;margin-top:5px;">
			 <B>&nbsp;&nbsp;&nbsp;&nbsp;STUDENT NUMBER</B>
			 ...
			 <div style="float:left; width:100px;font-size:15px; height:34px;color:#000;margin-top:5px;">
			 <B style="font-size:15px;">&nbsp;&nbsp;&nbsp;&nbsp;Page  <?PHP
...
?></B>
			 ...
			 <div style="float:left; width:249px;font-size:18px; height:34px;color:#000;font-weight:normal;font-family:Mingliu-ExtB;font-weight:normal;">
			 &nbsp;&nbsp;&nbsp;&nbsp;<?php echo $mats=$row["matricule"];?>
			 
		    </div>
		  
			 <div style="float:left; width:249px;font-size:18px; height:34px;color:#000;font-family:Mingliu-ExtB;font-weight:normal;">
			&nbsp;&nbsp;&nbsp;&nbsp; <?php echo $date=date("j -m- Y");?>
			 ...
			 <div style="float:left; width:100px;font-size:18px; height:34px;color:#000;">
			 <B>&nbsp;&nbsp;&nbsp;&nbsp; </B>
		  ...
		  <div style="float:left; width:619px;font-size:18px; height:70px; color:#000; ">
		 
		 
			 <div style="float:left; width:380px;font-size:18px; height:34px;color:#000;margin-top:5px;">
			 <B>&nbsp;&nbsp;&nbsp;&nbsp;STUDENT NAMES</B>
			 
		    </div>
		  
			 <div style="float:left; width:220px; font-size:18px;height:34px;color:#000;margin-top:5px;">
			 <B>&nbsp;&nbsp;&nbsp;&nbsp;ACADEMIC YEAR</B>
			 
		    </div>
		  
		   <div style="float:left; width:380px;font-size:18px; height:34px;color:#000;font-family:Mingliu-ExtB;font-weight:normal;">
			&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row["fname"];?>
			 
		    </div>
		  
			 <div style="float:left; width:220px;font-size:18px; height:34px;color:#000;;font-family:Mingliu-ExtB;font-weight:normal;">
			&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $pt=$row["db1"];?>
		 ...
		 <div style="float:left; width:1400px; height:font-size:18px;100px;margin-top:4px; color:#000; border:1px solid #000;">
		 
		 <div style="float:left; width:179px; height:100px; color:#000; border-right:1px solid #000;">
 <div style="float:left; width:179px;font-size:18px; height:30px; BORDER-BOTTOM:1PX SOLID #000;MARGIN-TOP:5PX;color:#000; TEXT-ALIGN:CENTER;FONT-WEIGHT:BOLD;">

		 DATE OF BIRTH
		 </div>
		 
		 
		 <div style="float:left; width:179px; font-size:18px;height:65px; color:#000; TEXT-ALIGN:CENTER;">

		 
		 <div style="float:left; width:59px;font-size:18px; height:65px;  border-right:1px solid #000;color:#000; TEXT-ALIGN:CENTER;">
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row["cxx2"];?>
		 	 ...
		 	 <div style="float:left; width:59px;font-size:18px; height:65px; color:#000; TEXT-ALIGN:CENTER;">
		 ...
		 <div style="float:left; width:379px;font-size:18px; height:100px; color:#000; border-right:1px solid #000;">

		 
		 
		 
		 <div style="float:left; width:379px; font-size:18px;height:30px;FONT-WEIGHT:BOLD; MARGIN-TOP:5PX;color:#000;TEXT-ALIGN:CENTER;">
		 ...
		 <div style="float:left; width:379px; font-size:18px;height:30px; MARGIN-TOP:5PX;color:#000;TEXT-ALIGN:CENTER;">
		 ...
		 <div style="float:left; width:379px;font-size:18px; height:30px; FONT-WEIGHT:BOLD;color:#000;TEXT-ALIGN:CENTER;">
		BUSINESS
		 ...
		 <div style="float:left; width:69px;font-size:18px; height:100px; color:#000; border-right:1px solid #000;">
		 
		 
		 <div style="float:left;font-size:18px; width:69px;FONT-WEIGHT:BOLD; height:30px;MARGIN-TOP:5PX; color:#000; TEXT-ALIGN:CENTER;">
		 
SEX

		 </div>
		 <div style="float:left;font-size:18px; width:69px; height:30px;MARGIN-TOP:5PX; color:#000; TEXT-ALIGN:CENTER;">
		 ...
		 <div style="float:left; width:69px;font-size:18px; height:30px; color:#000; TEXT-ALIGN:CENTER;font-family:Mingliu-ExtB;font-weight:normal;">
		 <?php echo $row["sex"];?>
 ...
 <div style="float:left; width:349px;font-size:18px; height:100px; color:#000; border-right:1px solid #000;">
 
 <div style="float:left; width:349px;font-size:18px; height:30px;FONT-WEIGHT:BOLD; color:#000; MARGIN-TOP:5PX;TEXT-ALIGN:CENTER;">
 DEPARTMENT
 
		 </div>
 
  <div style="float:left; width:349px;font-size:18px; height:30px; color:#000; TEXT-ALIGN:CENTER;">

 
		 </div>
 
 <div style="float:left; width:349px;font-size:18px; height:30px;color:#000; MARGIN-TOP:5PX;TEXT-ALIGN:CENTER;font-family:Mingliu-ExtB;font-weight:normal;">
<?php echo $deptt=$row["departmet"]; $level=$row["levels"];?>
		  ...
		  <div style="float:left; width:319px;font-size:18px; height:100px; color:#000; ">
 <div style="float:left; width:319px; height:70px;MARGIN-TOP:10PX; color:#000; text-align:center;font-weight:bold;line-height:23px; ">
		 ...
		 <div style="float:left; width:800px; font-size:18px;height:25px;color:#000; ">
		  Signature
		 </div>
...
$query = mysql_query("select  * from subject where  year1='$level' and department='$deptt' and year2='1' and  db1>'' and acc='$pt'  order by db1 ASC"); 
...
from resit where db1='$take' and fname='$courseps' and matricule='$mats' and departmet='$deptt' and sex='1' and levels='$level'  and fname>'' "); 
$row = mysql_fetch_assoc($qry); 
$ns=$row['total']; 
...
$query33="update subject set credit='$tm'
 where subject='$courseps' ";
...
mysql_query ($query3) or die ('could not updated:'.mysql_error());
 ...
 ?>
		 	 ...
		 	 <div style="float:left; width:54px; height:15px; color:#000; text-align:center;">
				 <DIV STYLE="float:left;margin-left:0px; width:60px; font-size:11px;text-align:center;height:auto;"><?PHP ECHO $mx=($ns);?>
		    </div>
...
from subject where  year1='$level' and department='$deptt' and year2='1' and  db1>'' and acc='$take' "); 
$row = mysql_fetch_assoc($qry); 
...
$qry = mysql_query("select  SUM(credit) as total
from subject where  year1='$level' and department='$deptt' and year2='1' and  db1>''  and acc='$pt'"); 
$row = mysql_fetch_assoc($qry); 
...
$query = mysql_query("select  * from resit where db1='$take' and matricule='$mats' and departmet='$deptt' and sex='3' and levels='$level'  and fname>''  order by fname ASC"); 
...
<?php 
$qry = mysql_query("select  db1 as total
from subject where subject='$courseps' and department='$deptt' and acc='$pt' "); 
$row = mysql_fetch_assoc($qry); 
echo $richooTTT=$row['total']; 

$qry = mysql_query("select  credit as total
from subject where subject='$courseps'  and acc='$pt'"); 
$row = mysql_fetch_assoc($qry); 
...
$qry = mysql_query("select  db1 as total
from resit where matricule='$mats' and db1='$pt' and sex='3'"); 
$row = mysql_fetch_assoc($qry); 
 $db1=$row['total']; 
	$fg=$db1;	
...
$query = mysql_query("select  * from subject where  year1='$level' and department='$deptt' and year2>='2'  and year2<='2'  and  db1>''   and acc='$take'order by db1 ASC"); 
...
$qry = mysql_query("select SUM(c101+c102) as total
from resit where db1='$take' and fname='$courseps' and matricule='$mats'and sex='2' and levels='$level'   "); 
$row = mysql_fetch_assoc($qry); $ns=$row['total']; 
...
mysql_query ($query3) or die ('could not updated:'.mysql_error());
 ...
 ?>
		 	 ...
		 	 <div style="float:left; width:54px; height:15px; color:#000; text-align:center;">
				 <DIV STYLE="float:left;margin-left:0px; width:60px; font-size:11px;text-align:
				 center;height:auto;"><?PHP ECHO $mx=($ns);?>
		    </div>
...
$qry = mysql_query("select  SUM(credit) as total
from subject where  year1='$level' and department='$deptt' and year2='2' and  db1>''  and acc='$take'"); 
$row = mysql_fetch_assoc($qry); 
...
<?php getSelectHtml('filetype', $filetype, array('PNG' => 'PNG - Portable Network Graphics', 'JPEG' => 'JPEG - Joint Photographic Experts Group', 'GIF' => 'GIF - Graphics Interchange Format')); ?>
 ...
 <div id="imageOutput">
		 	 ...
		 	 <div style="float:left; width:220px;margin-left:200px; height:200px; color:#000; text-align:center;">
		 <br>
		 <table cellspacing="2" cellpadding="1" width="250px" style="font-size:12px;">
		 
		 <?php
$query="select * from gradeb order by from1 ASC";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
...
<?php  echo $col8=$row['from2'];?>
			 </td>
<td>

<?php  echo $col8=$row['grade'];?>
