...
$query = mysql_query("select  * from resit where db1='$pt' and matricule='$mats' and departmet='$deptt' and sex='2' and (c101+c102)>'' and levels='$level'order by fname ASC"); 
		 ...
		 <div style="float:left; width:653px; height:15px; color:<?php echo $color;?>;font-weight:normal;">
...
from resit  where matricule='$mats' and departmet='$deptt' and levels='$level' and sex='1'  "); 
$row = mysql_fetch_assoc($qry); 
  $savept19=$row['total']; 
...
$qry = mysql_query("select SUM(c108*c104) as total
from resit  where matricule='$mats' and departmet='$deptt' and levels='$level' and sex='2'  "); 
$row = mysql_fetch_assoc($qry); 
  $savept20=$row['total']; 
...
?></b> </div>
		 ...
		 <div style="float:left;width:1300px; HEIGHT:40PX; margin-top:-280px; ">   
		 
		 <div style="float:left;width:200px; HEIGHT:40PX; "></div>
		 
		  <div style="float:left;width:250px; HEIGHT:40PX; margin-left:120px;text-transform:uppercase; ">
		 ...
		 <div style="float:left;width:390px; HEIGHT:40PX; margin-left:240px;">
		 <div style="float:left;width:390px; HEIGHT:35PX; ">DEPUTY REGISTRAR I/C OF ACADEMIC AFFAIRS</div>
		 
		
		 <div style="float:left;width:200px; HEIGHT:5PX;border-bottom:1px dashed #000; "></div>
