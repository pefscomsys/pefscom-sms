...
$search=$_POST["search"];
$flag=0;
$query="select * from $table  where  db1='$take' and  departmet='$off1' and levels='200' and ((c101+c102)+(c103+c104)+(c105+c106)+(c107+c108)+(c109+c110)
...
$result=mysql_query($query);
		 ...
		 echo "<tr ><td font-color=#000>",$row[2],"</td><td>&nbsp;",$row[3],"</td><td><a href='",$row[1],"'>&nbsp;",$row[5],"
		  </a></td><td><a href='checkst111cus.php?roll=",$row[0],"'>FINAL TRANSCRIPT</a>
		  </td></tr>";
