...
from page where cn='7' and id='$ids'   "); 
...
from page where cn='2' and id='$ids'   "); 
$row = mysql_fetch_assoc($qry); 
...
<table style=" border:1px solid silver ; background:#fff; color:#000; font-size:12px;" cellpadding="10px" bgcolor="#fff"cellspacing="0px" align="center" border="0">
   <tr><td>&nbsp;</td><td><h1>Transcript for entire department</h1></td></tr>



   <tr>
      <td colspan="4" width="650px" style="  baackground:#ccc;color:#000; font-size:20px;"></td>
    </tr><tr><td><input type="text" name="deptt" size="10" value="<?PHP ECHO $row['departmet'];?>"><td></tr>
    <tr> </td>  <input type="text" name="levels" size="10" value="<?php echo $row['levels'];?>">
	<input type="hidden" name="roll" size="10" value="<?php echo $row[0];?>"> <input type="hidden" name="cxx5" size="10" value="<?php echo $row['cxx5'];?>">
