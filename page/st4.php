...
<div style="float:left;margin-top:5px;margin-left:5px;">&#9658;</div>
 ...
 <div style="float:left; width:500px;color:#1188aa; height:30px;font-size:28px;color:#fff;text-transform:uppercase;"><?php echo $pic;?></div>
...
<form name="form1" action="ms2r.php?roll=<?php echo $fish;?>" method="post" enctype="multipart/form-data" >
