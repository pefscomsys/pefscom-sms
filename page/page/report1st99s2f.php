...
$form=$_POST["form"];
$query="select * from $table where db1='$take' and departmet='$deptt' and levels='$levels' and cxx5='$cxx5' order by matricule ASC";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
...
$stand2="";
 ...
 echo $stand2="<B STyle='font-size:28px; margin-top:65px; margin:auto; width:950px; color:red; '>PLEASE PAY YOUR BALANCE FEES MR/ MRS $fm <br> YOUR BALANCE IS $amounts</b>";
 exit;
}
?><?php } ?>
<?php
$form=$_POST["form"];
$query="select * from $table where db1='$take' and fname='$fname'and cxx5='$cxx5' order by levels ASC";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
...
$i=1;
		...
		$cas=$row['c101'];?>
			  ...
			  <div style="float:left;font-weight:normal;border-bottom:1px dashed #ccc; width:298px;font-family:arial;height:25px;border-left:1px solid #ccc; 
#ccc; ">
		  <div style="float:left;margin-top:5px;margin-left:2px;">
		<?php 
...
Deputy Registrar i/c Academics Affairs</b>
		  </div>
