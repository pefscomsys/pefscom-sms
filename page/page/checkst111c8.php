...
from page where cn='10' and id='$ids'  "); 
...
?><?php $mm=$row[0];$levels=$row['levels'];$deptt=$row['departmet'];?>
<br>
<br>
<br>
<br>
<br>
<form name="update" method="post" action="<?php echo $rsy;?>?roll=<?php echo $mm;?>&levels=<?php echo $levels;?>">
