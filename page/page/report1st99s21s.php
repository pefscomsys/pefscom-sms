...
$queryr3="update subject set credit='$richooTTTy'
...
mysql_query ($queryr3) or die ('could not updated:'.mysql_error());
...
from subject where department='$deptt'and year1='$level'  and year2='1'"); 
$row = mysql_fetch_assoc($qry); 
 $tcredit=$row['total'];
...
$qry = mysql_query("select sum(credit) as total
from subject where department='$deptt'and year1='$level'  and year2='2'"); 
$row = mysql_fetch_assoc($qry); 
 $tcredit=$row['total'];
