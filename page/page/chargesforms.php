...
<form name="look" method="post" action="charges.php">
...
<td colspan="4" style=" color:#fff; font-size:20px">PUBLISH CA AND EXAM MARK/publier des marques</td>
</tr>
<tr>
<td ></td>
<td>
...
<td >Select Acc Year/ 
choisissez l'année</td>
<td>

<select name="take">
<?php
$rs=mysql_query("Select * from courses where c110='$ids' group by db1 order by  db1 ASC",$link);
	  while($row=mysql_fetch_array($rs))
{
if($row[1]==$fees)
{
...
<td>Select Level/choisissez le niveau</td><td>
<select name="levels">
<?php
...
<tr>
<td>Semester/semestre</td><td><select name="sex" class="required" id="select8"style="background:#ccc;">
