...
$form=$_POST["form"];
$query="select * from $table where db1='$take' and departmet='$deptt' and levels='$levels' and c139='1' and cxx5='$cxx5' order by levels ASC";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
		 ...
		 ?>
		  ...
		  <div style="margin:auto; width:800px; height:980px; ">
...
from courses where matricule='$matss'   "); 
$row = mysql_fetch_assoc($qry); 

echo $rsy=$row['total']; 
		  echo $fname=$row['fname'];?></b>
		 </div>
...
$query = mysql_query("select  * from resit where db1='$take' and matricule='$matss' and departmet='$deptt' and sex='3' and levels='$level'order by fname ASC"); 
...
$query3="update resit set c103='$fts',c104='$tm'
 where matricule='$matss' and departmet='$deptt'and levels='$level' and sex='3' and db1='$take' and fname='$courseps'";
...
from resit where matricule='$matss' and departmet='$deptt'and levels='$level' and sex='3' and db1='$take'  "); 
$row = mysql_fetch_assoc($qry); 
$save=$row['total']; 
...
$query4e="update courses set c129='$ui' where departmet='$deptt' and levels='$level' and db1='$take' and matricule='$matss' and c139='1'";



mysql_query ($query4e) or die ('could not updated:'.mysql_error());
