...
<table style=" border:1px solid silver" cellpadding="2px" cellspacing="0px" align="center" border="0" width="1150px">
<tr>
...
$result=mysql_query($query);
		 ...
		 echo "<tr ><td font-color=#000>",$row[2],"</td><td>&nbsp;",$row[3],"</td><td><a href='",$row[1],"'>&nbsp;",$row[5],"
		  </a></td><td><a href='addtotal111cy.php?roll=",$row[0],"'>INDIV</a>|
		  <a href='checkst111cy.php?roll=",$row[0],"'>GROUP</a>
		  |<a href='graph/html/certificatesss.php?rollsps=",$row[0],"'>Trans</a> |<a href='graph/html/certificates.php?rollsps=",$row[0],"'>Tran Individual</a>
		  
		  |<a href='graph/html/certificatess.php?rollsps=",$row[0],"'>200 Tran </a></td>
