...
<tr   style="border-bottom:1px solid #000;">
      <td style="text-transform:uppercase;width:250px;">Acc. y</td
	  ><td>

<select name="db1"style="background:#fff;padding4px;">
<?php
$rs=mysql_query("Select * from courses group by db1 ASC",$link);
	  while($row=mysql_fetch_array($rs))
{
if($row[1]==$fees)
{
...
<?php
$rs=mysql_query("Select * from subject where  id='$ids' and db1>'' order by  db1",$link);
	  while($row=mysql_fetch_array($rs))
{
if($row[1]==$fees)
{
...
<div style="float:left; width:350px;height:30px;margin-top:50px; ">	
<div style="float:left; width:10px; height:30px; background:#989898;">	
