...
from page where cn='9'  and id='$ids'  "); 
...
$mxc1=$row["levels"];
 ...
 $stmyyyy1="";}
elseif($mxc1>="200" && $mxc1<="200"){

  $stmyyyy1="come1all31.php"; 
}elseif($mxc1>="300" && $mxc1<="300"){

  $stmyyyy1="come1all31.php"; 
}

elseif($mxc1>="400" && $mxc1<="400"){

  $stmyyyy1="btechall31.php"; 
}
 
?><?php echo $stmyyyy1;?>?roll=<?php echo $nki;?>?roll=<?php echo $nki;?>">
...
<table style=" border:1px solid silver ; background:#fff; color:#000; font-size:12px;" cellpadding="10px" bgcolor="#fff"cellspacing="0px" align="center" border="0">
	...
	<input type="hidden" name="fname" size="10" value="<?php echo $row['fname'];?>"><input type="hidden" name="cxx5" size="10" value="<?php echo $row['cxx5'];?>">
