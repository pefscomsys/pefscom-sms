...
<DIV Style="font-family:Stencil Std;color:rgba(230,164,64, 0.9);width:550px; height:30px;margin-top:7px;margin-left:3px; ">SELECT CLASS TO CHANGE PICTURE OR NAME</a>
...
<a href="pic1.php">
<div style="float:left; width:200px;margin-toP:25px;text-align:center; border:1px solid #000; height:30px; background:#20bdff;">Complete Student</div></a>
